#!/usr/bin/env python3
"""Build OWP_2029 Cortex v2 17-tab JCR. Exxel Pacific Parsonage.
...
data = json.load(open('/sessions/keen-determined-mccarthy/work/2029_data.json'))
CODES = data['codes']
...
JOB = "2029"
NAME = "Exxel Pacific Parsonage"
PROJECT_DESC = "Parsonage — historic house restoration + new build, plumbing scope"
GC = "Exxel Pacific, Inc."
GC_CUST_CODE = "2029EP"
OWNER = "Exxel Pacific (self-performed developer)"

# Financial (JDR footer)
REVENUE = 1_123_747.00
EXPENSES = 563_588.99
NET_PROFIT = 560_158.01
RETAINAGE = 56_289.55
SRC_GL = 34_886.41
SRC_AP = 243_624.11
SRC_PR = 188_045.50

CONTRACT_ORIG = 1_113_220.00
CONTRACT_FINAL = 1_123_747.00
CO_TOTAL_IMPLIED = CONTRACT_FINAL - CONTRACT_ORIG  # +10,527.00
CO_TOTAL_DOCUMENTED = 10_527  # 8 executed COs per CO/COR folders
...
SRC_JDR = "2029 Job Detail Report.pdf (Sage Timberline, 04/03/2026, 190 pages)"
SRC_CONTRACT = "Exxel Pacific Parsonage Subcontract"
SRC_PROPOSAL = "Exxel Pacific Parsonage Proposal"
SRC_PTAG = "Parsonage fixture schedule"
SRC_NARRATIVE = "Parsonage plumbing narrative"
SRC_FOLDER = "owp-2029/"
...
title(ws, f"Job #{JOB} · {NAME}",
      f"Cortex JCR Cortex v2  •  {GC} (customer {GC_CUST_CODE})  •  Parsonage, WA  •  Owner: {OWNER}")
put(ws, "B5", "PROJECT OVERVIEW", BOLD, F_ALT)
overview = [
    ("Project Job #", JOB, SRC_JDR + " header"),
    ("Project Name (Sage)", NAME, SRC_JDR + " header"),
    ("Project Description", "Parsonage — 296-unit new construction plumbing", SRC_CONTRACT + " / AR line descriptions"),
    ("General Contractor", GC, SRC_CONTRACT),
    ("Customer Code (Sage)", GC_CUST_CODE, SRC_JDR),
    ("Owner / Developer", OWNER, SRC_CONTRACT),
    ("Jobsite Location", "Parsonage, WA", SRC_CONTRACT),
...
scope_lines = [
    ...
    "296-unit multifamily new construction at Parsonage, WA.",
...
kpis = [
    ...
    ("Project Description", "project_desc", "Parsonage — 296-unit new construction plumbing", "Profile", "Contract + AR lines", "Verified", SRC_CONTRACT),
    ...
    ("Location", "location", "Parsonage, WA", "Profile", "Contract address", "Verified", SRC_CONTRACT),
...
metrics = [
    ...
    ("project_desc", "Project Description", "Parsonage — 296-unit multifamily plumbing", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
    ...
    ("location", "Location", "Parsonage, WA", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
...
# ============ SAVE ============
import os
out = "/sessions/keen-determined-mccarthy/work/OWP_2029_JCR_Cortex_v2.xlsx"

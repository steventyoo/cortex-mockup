#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2029 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2029_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2029_Notion_v2.xlsx')
...
# ── Job Info team for 2029 (Exxel Pacific Parsonage) ─────
TEAM = [
    ("GC",             "Exxel Pacific, Inc."),
    ("GC PM",          "Brett / Franklin (per project subfolders)"),
    ("GC Superintendent","N/A"),
    ("GC PE",          "N/A"),
    ("Developer",      "Exxel Pacific (self-performed)"),
    ("Architect",      "N/A"),
    ("Structural",     "N/A"),
    ("Acoustical",     "N/A"),
    ("ADA Consultant", "N/A"),

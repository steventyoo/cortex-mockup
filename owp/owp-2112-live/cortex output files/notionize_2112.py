#!/usr/bin/env python3
"""
notionize_2112.py — Build the Notion-styled 2-tab summary workbook for
Job 2112 (Compass Northgate M2) — live project.

Input:   2112_data.json  (from parse_2112.py)
Output:  OWP_2112_JCR_Summary_Notion_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2112_JCR_Summary_Notion_v2.xlsx'
...
def generate_predictive_signals(data):
    ...
    signals.append(('Retention', '✓ OK', f'${META_2112["retention"]:,.0f} held · 5% standard'))
...
if __name__ == "__main__":
    ...
    out = build_notion_workbook(dict(META_2112))
    print(f"Built: {out}")

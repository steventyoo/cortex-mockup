#!/usr/bin/env python3
"""
parse_2112.py — Parse Job 2112 JDR PDF → 2112_data.json

Structured parse of the 68-page Sage Timberline Job Detail Report for
Job 2112 (BMDC Services, Big 3 Apartments — 20-unit sibling to #2104
Big 1410). Mirrors the per-project parse convention established by
parse_2098/parse_2103/parse_2104.

The underlying parsing logic is the generalized JDR parser shared with
2111 and earlier 2012 (see parse_live_jdr.py in workspace root). This
...
Customer code: 2112BM · Client: BMDC Services, LLC · GC: BMDC.
"""
import json
import re
import sys
...
# owp-2112-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2112 Job Detail Report.pdf'
OUT = _HERE / '2112_data.json'
...
PROJECT_META = {
    ...
    'location': 'Seattle, WA (Capitol Hill area)',
    'project_type': '5-story mixed-use residential (20 units)',
    'units': 20,
    'total_fixtures': 100,
    'architect': None,
    ...
    'contract_original': 664100,
    'contract_final': 696427,
    'total_cos_net': 32327,
    'billed_to_date': 518063.00,
    'retention_amount': 25903.15,
    'retention_rate': 0.05,
}

#!/usr/bin/env python3
"""
build_2112.py — Build the 17-tab JCR Cortex v2 workbook for Job 2112
(Compass Northgate M2) — live/active project.

Input:   2112_data.json  (from parse_2112.py)
Output:  OWP_2112_JCR_Cortex_v2.xlsx
"""
import json
...
DATA_FILE = _HERE / '2112_data.json'
OUT_FILE = _HERE / 'OWP_2112_JCR_Cortex_v2.xlsx'
...
META_2112 = {
    'job_id': '2112',
    'name': 'Big 3 Apartments',
    'short_name': 'Big 3',
    'gc': 'BMDC Services, LLC',
    'owner': 'BMDC Big 3 LLC',
    'units': 20,
    'total_fixtures': 0,
    'insurance': 'Not Wrap',
    'job_start': 'May 2025',
    'expected_completion': 'Jul 2026',
    'architect': 'Robison Engineering',
    'mep': 'Robison Engineering',
    'location': 'Seattle, WA',
    'project_type': 'Small multifamily (20 units)',
    'subcontract_number': 'TBD',
    'gc_project_number': 'TBD',
    'report_date': 'Mar 2026',
    'billed': 518063.0,
    'retention': 25903.15,
    'build_date': '2026-04-24',
    'contract_original': 664700,
    'contract_final': 696345,
    'executed_co_count': 9,
    'cor_count': 3,
    'rfi_count': 0,
    'asi_count': 0,
    ...
    'cos': [
        {'co': 'CO#01', 'desc': 'Condensate drain additions', 'amount': 11500},
        {'co': 'CO#02', 'desc': 'Matte black flush lever upgrade', 'amount': 1120},
        {'co': 'CO#03', 'desc': 'Water metering additions', 'amount': 20100},
        {'co': 'CO#04', 'desc': 'Temporary water service', 'amount': 1362},
        {'co': 'CO#05', 'desc': 'Minor re-routes + small adds', 'amount': -1737},
    ],
    '_old_cos': [
...
def generate_predictive_signals(data):
    ...
    ret = abs(META_2112.get('retention', 0))
    billed = abs(META_2112.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2112['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2112))
    print(f"Built: {out}")

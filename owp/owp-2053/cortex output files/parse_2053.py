...
# owp-2053/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2053 Job Detail Report.pdf'
OUT = _HERE / '2053_data.json'

PROJECT_META = {
    'job_number': '2053',
    'job_name': "Bellevue Parkside",
    'general_contractor': "Compass Harbor Construction",
    'owner': "Bellevue Parkside, LP",
    'location': "Bellevue, WA (75 102nd Ave NE)",
    'project_type': "Mixed-use multifamily (BLU Apartments) + retail",
    'units': 135,
    'total_fixtures': None,
    'architect': 'Encore Architects',
    'mep_engineer': 'Franklin Engineering',
    'report_date': '2026-04-03',
    'contract_original': 2241309,
    'total_cos_net': None,
    'contract_final': None,                  # will be extracted from JDR
    'executed_co_count': 11,
    'cor_count': 10,
    ...
    'end_date': "2020-05",
    'retention_rate': 0.05,
    'retention_amount': None,                # extracted from JDR
    'billed_to_date': None,                  # extracted from JDR
    'subcontract_no': "22-0500",
    'effective_date': "May 23, 2018",
    'insurance': "OCIP / Wrap-up enrollment on file",
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2053 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

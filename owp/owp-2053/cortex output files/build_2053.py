...
DATA_FILE = _HERE / '2053_data.json'
OUT_FILE = _HERE / 'OWP_2053_JCR_Cortex_v2.xlsx'
...
META_2053 = {
    'job_id': '2053',
    'name': "Bellevue Parkside",
    'short_name': "Parkside",
    'gc': "Compass Harbor Construction",
    'owner': "Bellevue Parkside, LP",
    'units': 135,
    'total_fixtures': None,
    'insurance': "OCIP / Wrap-up enrollment on file",
    'job_start': "2018-05",
    'expected_completion': "Closed (2020-05)",
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2053.get('retention', 0))
    billed = abs(META_2053.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2053['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2053))
    print(f"Built: {out}")

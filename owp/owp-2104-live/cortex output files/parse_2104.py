#!/usr/bin/env python3
"""
parse_2104.py — Parse Job 2104 JDR PDF → 2104_data.json

Structured parse of the 92-page Sage Timberline Job Detail Report for
Job 2104 (BMDC, Big 1410). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2104BM · Client: BMDC Services, LLC · GC: BMDC.
"""
import json
import re
...
# owp-2104-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2104 Job Detail Report.pdf'
OUT = _HERE / '2104_data.json'

PROJECT_META = {
    'job_number': '2104',
    'job_name': 'Big 1410 Apartments',
    'general_contractor': 'BMDC Services, LLC',
    'owner': 'BMDC Services, LLC',
    'location': '1410 E Howell St, Seattle, WA 98122',
    'project_type': '5-story multifamily residential',
    'units': 24,
    'total_fixtures': 200,
    'architect': None,
    'mep_engineer': None,
    'report_date': '2026-04-03',
    'contract_original': 1143800,
    'total_cos_net': 52749,
    'contract_final': 1196549,
    'executed_co_count': 4,
    'cor_count': 5,
    'cancelled_cor_count': 1,
    'rfi_count': 7,
    'asi_count': 0,
    'submittal_count': 77,
    'total_pos': 135,
    ...
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 59686.70,
    'billed_to_date': 1193734.00,
    'ri_foreman': 'Tommy/Ben',
    'trim_foreman': None,
    'gc_pm': None,
    'gc_sup': None,
    'gc_pe': None,
    'insurance': 'Standard (COI)',
    'gc_subcontract_number': '22-0500-01',
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2104"', 'Job Number: 2104',
    'Job Name: BMDC, Big 1410', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 92-page 2104 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',
        'project': project,
        'totals': totals,
        'labor': labor,
        'report_record': {
            'job_number': '2104',
            'job_name': 'BMDC, Big 1410',
            'report_date': '2026-04-03',

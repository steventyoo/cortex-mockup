"""
notionize_2041.py — Build OWP_2041_JCR_Summary_Notion_v2.xlsx

17-tab Notion-styled summary workbook for project #2041 Luna Apartments
(Chinn Construction / 2749 California Ave SW, Seattle).

Consumes:
    /sessions/gracious-relaxed-pascal/2041_data.json          (JDR-parsed facts)
    /sessions/gracious-relaxed-pascal/2041_enriched_meta.json (GDrive-enriched meta)

Outputs:
    /sessions/gracious-relaxed-pascal/mnt/cortex-mockup/owp/owp-2041/cortex output files/
        OWP_2041_JCR_Summary_Notion_v2.xlsx
...
DATA_JSON = BASE / '2041_data.json'
META_JSON = BASE / '2041_enriched_meta.json'
OUT_DIR   = BASE / 'mnt' / 'cortex-mockup' / 'owp' / 'owp-2041' / 'cortex output files'
OUT_PATH  = OUT_DIR / 'OWP_2041_JCR_Summary_Notion_v2.xlsx'
...
SRC_JDR  = '2041 Job Detail Report.pdf (Sage Timberline, 04/03/2026)'
SRC_LIST = 'OWP Project List with Schedule - UPDATED 04-01-26.xlsx'
SRC_CNTR = '2041-Chinn Construction subcontract + Job Info sheet'
...
def build_overview(wb, d, m):
    ...
    hero(ws,
         ...
         f"Cortex JCR v2  •  {meta['general_contractor']} (customer 2041CC)  •  "
    ...
    rows_overview = [
        ...
        ('Project Description',       f"Luna Apartments — {units}-unit mixed-use residential + PCC retail, West Seattle", SRC_LIST + ' + contract'),
        ('General Contractor',        meta['general_contractor'],               SRC_LIST),
        ('Customer Code (Sage)',      '2041CC',                                 SRC_JDR),
        ...
        ('Architect',                 meta['architect'],                        'Chinn Luna project info.pdf'),
    ...
    scope_lines = [
        ...
        f"4-story residential + PCC retail ground floor + P1/P2 parking.",
        f"GC: {meta['general_contractor']} (2041CC); Owner: {meta['owner']}.",
...
def build_po(wb, d, m):
    ...
    rows = [
        ('PRIME',   meta['contract_signed_date'], meta['general_contractor'],
         ...
         f"Luna Apartments plumbing ({meta['units']} units + retail) — per Div 22",
...
def build_insights(wb, d, m, workers_data):
    ...
    rows = [
        ...
        ('INSURANCE',
         ...
         'Verified', SRC_LIST),
        ('SCOPE CONTEXT',
         f"Luna Apartments — {meta['units']}-unit mixed-use (102 Type B + 6 Type A/ADA) + PCC retail + "
...
def _compute_kpis(d, m, workers_data):
    ...
    return [
        ...
        ('Architect',             'architect',        meta['architect'], 'Profile', 'text', '', 'Chinn Luna project info.pdf'),

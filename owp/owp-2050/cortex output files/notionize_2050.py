"""
notionize_2050.py — Build OWP_2050_JCR_Summary_Notion_v2.xlsx

17-tab Notion-styled summary workbook for project #2050 Compass 2100 E Madison Apartments
(12 Madison Investment LLC / 915 E Spruce St, Seattle).

Consumes:
    /sessions/gracious-relaxed-pascal/2050_data.json          (JDR-parsed facts)
    /sessions/gracious-relaxed-pascal/2050_enriched_meta.json (GDrive-enriched meta)

Outputs:
    /sessions/gracious-relaxed-pascal/mnt/cortex-mockup/owp/owp-2050/cortex output files/
        OWP_2050_JCR_Summary_Notion_v2.xlsx
...
DATA_JSON = BASE / '2050_data.json'
META_JSON = BASE / '2050_enriched_meta.json'
OUT_DIR   = BASE / 'mnt' / 'cortex-mockup' / 'owp' / 'owp-2050' / 'cortex output files'
OUT_PATH  = OUT_DIR / 'OWP_2050_JCR_Summary_Notion_v2.xlsx'
...
SRC_JDR  = '2050 Job Detail Report.pdf (Sage Timberline, 04/03/2026)'
SRC_LIST = 'OWP Project List with Schedule - UPDATED 04-01-26.xlsx'
SRC_CNTR = '2050-Shelter Holdings subcontract 220500-01 + Boren & Spruce CO docs'
...
def build_overview(wb, d, m):
    ...
    hero(ws,
         ...
         f"Cortex JCR v2  •  {meta['general_contractor']} (customer 2050SH)  •  "
    ...
    rows_overview = [
        ...
        ('Project Description',       f"Compass 2100 E Madison Apartments — {units}-unit mixed-use mid-rise (47 Type B + 3 Type A ADA + 3 retail), Seattle Capitol Hill", SRC_LIST + ' + contract'),
        ('General Contractor',        meta['general_contractor'],               SRC_LIST),
        ('Customer Code (Sage)',      '2050SH',                                 SRC_JDR),
        ...
        ('Architect',                 meta['architect'],                        'Compass 2100 E Madison Apartments project info.pdf'),
    ...
    scope_lines = [
        ...
        f"Mixed-use mid-rise multi-family (Type 1A podium + Type VA above) with 3 ground-floor retail spaces.",
        f"GC: {meta['general_contractor']} (2050SH); Owner: {meta['owner']}.",
...
def build_po(wb, d, m):
    ...
    rows = [
        ('PRIME',   meta['contract_signed_date'], meta['general_contractor'],
         ...
         f"Compass 2100 E Madison Apartments plumbing ({meta['units']} units, 7 stories) — per Div 22",
...
def build_insights(wb, d, m, workers_data):
    ...
    rows = [
        ...
        ('INSURANCE',
         ...
         'Verified', SRC_LIST),
        ('SCOPE CONTEXT',
         f"Compass 2100 E Madison Apartments — {meta['units']}-unit mixed-use mid-rise (47 standard + 3 Type A ADA) + 3 retail + "
...
def _compute_kpis(d, m, workers_data):
    ...
    return [
        ...
        ('Architect',             'architect',        meta['architect'], 'Profile', 'text', '', 'Compass 2100 E Madison Apartments project info.pdf'),
...
def main():
    ...
    # Fill 2050-specific defaults in case enriched_meta lacks the 2041-style fields
    _m = meta['meta']

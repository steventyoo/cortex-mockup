#!/usr/bin/env python3
"""
notionize_2098.py — Build the Notion-styled 2-tab summary workbook for
Job 2098 (Chinn, Trailside 2) — live project.

Input:   2098_data.json  (from parse_2098.py)
Output:  OWP_2098_JCR_Summary_Notion_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2098_JCR_Summary_Notion_v2.xlsx'
...
if __name__ == "__main__":
    ...
    out = build_notion_workbook(dict(META_2098))
    print(f"Built: {out}")

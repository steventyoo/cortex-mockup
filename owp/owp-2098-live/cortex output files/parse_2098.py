#!/usr/bin/env python3
"""
parse_2098.py — Parse Job 2098 JDR PDF → 2098_data.json

Structured parse of the 392-page Sage Timberline Job Detail Report for
Job 2098 (Chinn, Trailside 2). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2098CC · Client: Chinn Construction, LLC · GC: Chinn.
"""
import json
import re
...
# owp-2098-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2098 Job Detail Report.pdf'
OUT = _HERE / '2098_data.json'

PROJECT_META = {
    'job_number': '2098',
    'job_name': 'Trailside Apartment Community Phase II',
    'general_contractor': 'Chinn Construction, LLC',
    'owner': 'Trailside Ph II SH Holdings, LLC (Dallas, TX)',
    'location': '4907 25th Ave NE, Seattle, WA 98105',
    'project_type': '7-story mixed-use student housing',
    'units': 170,
    'total_fixtures': 1200,
    'architect': 'Weber Thompson Architects',
    'mep_engineer': 'Marx-Okubo',
    'report_date': '2026-04-03',
    'contract_original': 6885880,
    'total_cos_net': 32085.74,
    'contract_final': 6917965.74,
    'executed_co_count': 18,
    'cor_count': 17,
    'cancelled_cor_count': 3,
    'rfi_count': 110,
    'asi_count': 12,
    'submittal_count': 6,
    'total_pos': 442,
    ...
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 345898.29,
    'billed_to_date': 6917965.74,
    'chinn_project_number': '23-0602',
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2098"', 'Job Number: 2098',
...
def main():
    ...
    print(f'  Net profit: ${net_profit:,.2f} ({net_profit/revenue*100:.1f}%)')
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 392-page 2098 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

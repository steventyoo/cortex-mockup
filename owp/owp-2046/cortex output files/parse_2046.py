#!/usr/bin/env python3
"""
parse_2046.py — Parse Job 2046 JDR PDF → 2046_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2046 (Marpac Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2046SH · Client: Boren and Spruce, LLC · GC: Marpac.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2046_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2046_data.json')

PROJECT_META = {
    'job_number': '2046',
    'job_name': 'Marpac 4218 Roosevelt',
    'general_contractor': 'Marpac',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2046" only', 'Job Number:2046',
    'Job Name: Marpac 4218 Roosevelt', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2046 JDR PDF. Mirrors Sam v4 test-labels structure.',

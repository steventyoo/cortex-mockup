#!/usr/bin/env python3
"""
notionize_2118.py — Build the Notion-styled 2-tab summary workbook for
Job 2118 (Holland, Ballard Blossom) — live project (pre-construction / DD).

Input:   2118_data.json  (from parse_2118.py)
Output:  OWP_2118_JCR_Summary_Notion_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2118_JCR_Summary_Notion_v2.xlsx'
...
if __name__ == "__main__":
    ...
    out = build_notion_workbook(dict(META_2118))
    print(f"Built: {out}")

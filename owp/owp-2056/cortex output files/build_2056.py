...
DATA_FILE = _HERE / '2056_data.json'
OUT_FILE = _HERE / 'OWP_2056_JCR_Cortex_v2.xlsx'
...
META_2056 = {
    ...
    'job_start': "2018-04",
    'expected_completion': "Closed (2020-09)",
    'architect': None,
    'civil': None,
    'structural': None,
    'mep': None,
    ...
    'contract_original': 5877400,
    'contract_final': 6034876,
    'executed_co_count': 0,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2056.get('retention', 0))
    billed = abs(META_2056.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2056['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2056))
    print(f"Built: {out}")

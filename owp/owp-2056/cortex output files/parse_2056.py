...
# owp-2056/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2056 Job Detail Report.pdf'
OUT = _HERE / '2056_data.json'

PROJECT_META = {
    'job_number': '2056',
    'job_name': "Acme Farms",
    'general_contractor': "Exxel Pacific",
    'owner': "Acme Farms (per Exxel)",
    'location': "Seattle, WA (1029 S Jackson Street, Central District)",
    'project_type': "Mixed-use multifamily + retail (LARGE — 321 units)",
    'units': 321,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
    ...
    'effective_date': "April 18, 2018",
    'insurance': "TBD — per Exxel standard",
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2056 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

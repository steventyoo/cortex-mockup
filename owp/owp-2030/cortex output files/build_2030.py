#!/usr/bin/env python3
"""Build OWP_2030 Cortex v2 17-tab JCR. Exxel Pacific East Union.
...
data = json.load(open('/sessions/keen-determined-mccarthy/work/2030_data.json'))
CODES = data['codes']
...
JOB = "2030"
NAME = "Exxel Pacific East Union"
PROJECT_DESC = "East Union — multifamily new construction plumbing, Seattle WA"
GC = "Exxel Pacific, Inc."
GC_CUST_CODE = "2030EP"
OWNER = "Lake Union Partners (developer)"

# Financial (JDR footer)
REVENUE = 2_322_781.00
EXPENSES = 1_437_428.97
NET_PROFIT = 885_352.03
RETAINAGE = 116_139.05
SRC_GL = 101_304.62
SRC_AP = 555_579.87
SRC_PR = 481_197.50

CONTRACT_ORIG = 2_135_080.00
CONTRACT_FINAL = 2_322_781.00
CO_TOTAL_IMPLIED = CONTRACT_FINAL - CONTRACT_ORIG  # +187,701.00
CO_TOTAL_DOCUMENTED = 187_701  # COs per Change Orders folder
...
SRC_CONTRACT = "Exxel Pacific East Union Subcontract"
SRC_PROPOSAL = "Exxel Pacific East Union Proposal"
SRC_PTAG = "East Union fixture schedule"
SRC_NARRATIVE = "East Union plumbing narrative"
SRC_FOLDER = "owp-2030/"
...
title(ws, f"Job #{JOB} · {NAME}",
      f"Cortex JCR Cortex v2  •  {GC} (customer {GC_CUST_CODE})  •  East Union, WA  •  Owner: {OWNER}")
put(ws, "B5", "PROJECT OVERVIEW", BOLD, F_ALT)
overview = [
    ("Project Job #", JOB, SRC_JDR + " header"),
    ("Project Name (Sage)", NAME, SRC_JDR + " header"),
    ("Project Description", "East Union — 296-unit new construction plumbing", SRC_CONTRACT + " / AR line descriptions"),
    ("General Contractor", GC, SRC_CONTRACT),
    ("Customer Code (Sage)", GC_CUST_CODE, SRC_JDR),
    ("Owner / Developer", OWNER, SRC_CONTRACT),
    ("Jobsite Location", "East Union, WA", SRC_CONTRACT),
...
scope_lines = [
    ...
    "296-unit multifamily new construction at East Union, WA.",
...
kpis = [
    ...
    ("Project Description", "project_desc", "East Union — 296-unit new construction plumbing", "Profile", "Contract + AR lines", "Verified", SRC_CONTRACT),
    ...
    ("Location", "location", "East Union, WA", "Profile", "Contract address", "Verified", SRC_CONTRACT),
...
metrics = [
    ...
    ("project_desc", "Project Description", "East Union — 296-unit multifamily plumbing", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
    ...
    ("location", "Location", "East Union, WA", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
...
# ============ SAVE ============
import os
out = "/sessions/keen-determined-mccarthy/work/OWP_2030_JCR_Cortex_v2.xlsx"

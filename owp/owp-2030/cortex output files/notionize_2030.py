#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2030 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2030_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2030_Notion_v2.xlsx')
...
# ── Job Info team for 2030 (Exxel Pacific East Union) ─────
TEAM = [

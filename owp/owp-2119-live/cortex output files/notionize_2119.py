#!/usr/bin/env python3
"""
notionize_2119.py — Build the Notion-styled 2-tab summary workbook for
Job 2119 (Holland, Ballard Blossom) — live project (pre-construction / DD).

Input:   2119_data.json  (from parse_2119.py)
Output:  OWP_2119_JCR_Summary_Notion_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2119_JCR_Summary_Notion_v2.xlsx'
...
META_2119 = {
    ...
    'units': 1,                              # Placeholder — no unit count yet
    'billed': 0.0,
    'retention': 0.0,
}
...
if __name__ == "__main__":
    ...
    out = build_notion_workbook(dict(META_2119))
    print(f"Built: {out}")

#!/usr/bin/env python3
"""
parse_2119.py — Parse Job 2119 JDR PDF → 2119_data.json

NOTE: No JDR PDF exists yet for 2119 as of the Apr 3 2026 Sage export.
Job is earliest-stage of any live project — only a mockup fixture
proposal ($4,700) from Nov 13, 2024 exists. No full construction bid
yet. Script provided for consistency; will pick up data the moment a
JDR is published and full proposals land in GDrive.

Project: 2119 (Exxel Pacific, The Frank) — 508 Fremont, Seattle, WA.
Developer: Graham (per GDrive folder naming). GC PM: Michael Fisher
(Exxel Pacific, Bellingham). Mockup proposal sent Nov 13, 2024.

Customer code: 2119EX · Client: Exxel Pacific, Inc. · GC: Exxel
(Michael Fisher, PM).
"""
import json
import re
...
# owp-2119-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2119 Job Detail Report.pdf'
OUT = _HERE / '2119_data.json'

PROJECT_META = {
    'job_number': '2119',
    'job_name': 'The Frank (508 Fremont)',
    'general_contractor': 'Exxel Pacific, Inc.',
    'owner': 'Graham (developer)',
    'location': '508 Fremont, Seattle, WA',
    'project_type': 'Multifamily — details TBD (mockup phase)',
    'units': None,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
    'report_date': '2026-04-03',
    'contract_original': None,            # No full construction bid yet
    'total_cos_net': 0,
    'contract_final': None,
    'executed_co_count': 0,
    'cor_count': 0,
    ...
    'billed_to_date': 0.0,
    'base_bid': None,
    'bid_date': '2024-11-13',             # Mockup proposal date
    'bid_labor': None,
    'bid_material': None,
    ...
    'bid_avg_wage': None,
    # Mockup proposal (Nov 13, 2024) — very early stage
    'mockup_proposal_total': 4700,        # Install-only for mockup unit
    'mockup_proposal_date': '2024-11-13',
    'mockup_pm_contact': 'Michael Fisher',
    'insurance': 'Standard (COI)',
    'tco_date': None,
    'gc_pm': 'Michael Fisher',            # Exxel PM (Bellingham office)
    'gc_pe': None,
    ...
    'bid_set_status': 'Sent by Exxel to OWP — pending OWP full proposal',
    'status_note': 'Pre-bid / mockup-only phase. No JDR yet. No full construction bid yet. Mockup-fixture proposal $4,700 (Nov 13, 2024). Next milestone: OWP full plumbing proposal + bid sheet to Exxel.',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2119"', 'Job Number: 2119',
    'Job Name: Exxel, The Frank', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'STUB: No JDR yet for 2119. Placeholder schema matches 2020 gold standard + 2049 v2.2 extensions. Will be populated when Sage publishes a Job Detail Report.',

#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2033 Cortex v2 workbook (17 tabs)
...
SRC = HERE / 'OWP_2033_JCR_Cortex_v2.xlsx'
OUT = HERE / 'OWP_2033_JCR_Summary_Notion_v2.xlsx'
...
# ── Job Info team for 2033 (Compass Vuecrest) ─────
TEAM = [
    ("GC",               "Compass Harbor Construction, LLC"),
    ("GC PM",            "Ryan Ames / Vince Dennison"),
    ("GC Superintendent","Todd Mortenson"),
    ("GC PE",            "Dan Peck"),
    ("Developer",        "Continental"),
    ("Owner",            "Bellevue Vuecrest, LP"),
    ("Architect",        "N/A"),
    ("Structural",       "N/A"),
    ("Acoustical",       "N/A"),
    ("ADA Consultant",   "N/A"),

#!/usr/bin/env python3
"""Parse 2033 JDR (Compass Vuecrest): cost codes, payroll workers, AP vendors, AR invoices.
Adapted from parse_2031.py. Input is pdftotext -layout output of the 2033 JDR PDF.
"""
import re, json, sys
...
JDR_TXT = HERE / '2033_jdr.txt'
OUT_JSON = HERE / '2033_data.json'

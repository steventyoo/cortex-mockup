#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2031 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/mnt/rhema-8170/cortex_v2_deliverables/OWP_2031_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/mnt/rhema-8170/owp-jcr-portfolio/OWP_2031_Issaquah_Gateway_Summary.xlsx')
...
# ── Job Info team for 2031 (Exxel Pacific Issaquah Gateway) ─────
TEAM = [
    ("GC",             "Exxel Pacific, Inc."),
    ("GC PM",          "Brett / Franklin (per project subfolders)"),
    ("GC Superintendent","N/A"),
    ("GC PE",          "N/A"),
    ("Developer",      "Katerra / Exxel Pacific"),
    ("Architect",      "N/A"),
    ("Structural",     "N/A"),
    ("Acoustical",     "N/A"),
    ("ADA Consultant", "N/A"),
    ("Interior Design","N/A"),
    ("MEP Engineer",   "Franklin Engineering"),
]

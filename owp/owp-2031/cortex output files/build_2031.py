#!/usr/bin/env python3
"""Build OWP_2031 Cortex v2 17-tab JCR. Exxel Pacific Issaquah Gateway.
...
data = json.load(open('/sessions/keen-determined-mccarthy/work/2031_data.json'))
CODES = data['codes']
...
JOB = "2031"
NAME = "Exxel Pacific Issaquah Gateway"
PROJECT_DESC = "Issaquah Gateway — large multifamily new construction plumbing (towers + flats), Issaquah WA"
GC = "Exxel Pacific, Inc."
GC_CUST_CODE = "2031EP"
OWNER = "Katerra / Exxel Pacific"

# Financial (JDR footer)
REVENUE = 5_187_754.00
EXPENSES = 2_427_408.23
NET_PROFIT = 2_760_345.77
RETAINAGE = 259_387.70
SRC_GL = 79_204.72
SRC_AP = 1_072_286.18
SRC_PR = 1_237_777.26

CONTRACT_ORIG = 5_051_600.00
CONTRACT_FINAL = 5_187_754.00
CO_TOTAL_IMPLIED = CONTRACT_FINAL - CONTRACT_ORIG  # +136,154.00
CO_TOTAL_DOCUMENTED = 136_154  # COs per Change Orders folder

# Cost code categories (note: 2028 has 27 codes)
LABOR_CODES = ["100","101","110","111","112","120","130","140","141","142","143","310","320","330"]
MATERIAL_CODES = ["210","211","212","220","230","240","241","242","243","410","420","430"]
...
SRC_JDR = "2030 Job Detail Report.pdf (Sage Timberline, 04/03/2026, 190 pages)"
SRC_CONTRACT = "Exxel Pacific Issaquah Gateway Subcontract"
SRC_PROPOSAL = "Exxel Pacific Issaquah Gateway Proposal"
SRC_PTAG = "Issaquah Gateway fixture schedule"
SRC_NARRATIVE = "Issaquah Gateway plumbing narrative"
SRC_FOLDER = "owp-2031/"
...
title(ws, f"Job #{JOB} · {NAME}",
      f"Cortex JCR Cortex v2  •  {GC} (customer {GC_CUST_CODE})  •  Issaquah Gateway, WA  •  Owner: {OWNER}")
put(ws, "B5", "PROJECT OVERVIEW", BOLD, F_ALT)
overview = [
    ("Project Job #", JOB, SRC_JDR + " header"),
    ("Project Name (Sage)", NAME, SRC_JDR + " header"),
    ("Project Description", "Issaquah Gateway — 296-unit new construction plumbing", SRC_CONTRACT + " / AR line descriptions"),
    ("General Contractor", GC, SRC_CONTRACT),
    ("Customer Code (Sage)", GC_CUST_CODE, SRC_JDR),
    ("Owner / Developer", OWNER, SRC_CONTRACT),
    ("Jobsite Location", "Issaquah Gateway, WA", SRC_CONTRACT),
...
scope_lines = [
    ...
    "296-unit multifamily new construction at Issaquah Gateway, WA.",
...
kpis = [
    ...
    ("Project Description", "project_desc", "Issaquah Gateway — 296-unit new construction plumbing", "Profile", "Contract + AR lines", "Verified", SRC_CONTRACT),
    ...
    ("Location", "location", "Issaquah Gateway, WA", "Profile", "Contract address", "Verified", SRC_CONTRACT),
...
metrics = [
    ...
    ("project_desc", "Project Description", "Issaquah Gateway — 296-unit multifamily plumbing", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
    ...
    ("location", "Location", "Issaquah Gateway, WA", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
...
# ============ SAVE ============
import os
out = "/sessions/keen-determined-mccarthy/mnt/rhema-8170/cortex_v2_deliverables/OWP_2031_JCR_Cortex_v2.xlsx"

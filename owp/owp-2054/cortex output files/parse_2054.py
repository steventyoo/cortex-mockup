...
# owp-2054/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2054 Job Detail Report.pdf'
OUT = _HERE / '2054_data.json'

PROJECT_META = {
    'job_number': '2054',
    'job_name': "800 5th Apartments",
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2054 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

#!/usr/bin/env python3
"""
notionize_2051.py — Build the Notion-styled 2-tab summary workbook for
Job 2051 (Chinn, Trailside 2) — live project.

Input:   2051_data.json  (from parse_2051.py)
Output:  OWP_2051_JCR_Summary_Notion_v2.xlsx
"""
import json
...
DATA_FILE = _HERE / '2055_data.json'
OUT_FILE = _HERE / 'OWP_2055_JCR_Summary_Notion_v2.xlsx'
...
META_2055 = {
    'job_id': '2055',
    'name': "Dockside Apartments",
    'gc': "Blueprint Capital Service",
    'units': 98,
    'billed': 1315429,
    'retention': 0.0,
}
...
if __name__ == "__main__":
    data = load_data()
    META_2055['predictive_signals'] = generate_predictive_signals(data)
    out = build_notion_workbook(dict(META_2055))
    print(f"Built: {out}")

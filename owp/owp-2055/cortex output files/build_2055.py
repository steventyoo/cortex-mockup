...
OUT_FILE = _HERE / 'OWP_2055_JCR_Cortex_v2.xlsx'
...
META_2055 = {
    ...
    'insurance': "Not Wrap",
    'job_start': "2018",
    'expected_completion': "Closed (2020-07)",
    'architect': None,
    'civil': None,
    'structural': None,
    'mep': None,
    ...
    'contract_original': 1142340,
    'contract_final': 1315429,
    'executed_co_count': 0,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2055.get('retention', 0))
    billed = abs(META_2055.get('billed', 0))
...
if __name__ == "__main__":
    ...
    out = build_workbook(dict(META_2055))
    print(f"Built: {out}")

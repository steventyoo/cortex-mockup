...
# owp-2055/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2055 Job Detail Report.pdf'
OUT = _HERE / '2055_data.json'

PROJECT_META = {
    'job_number': '2055',
    'job_name': "Dockside Apartments",
    'general_contractor': "Blueprint Capital Services, LLC",
    'owner': "Blueprint",
    'location': "Seattle, WA (6860 E Green Lake Way N)",
    'project_type': "Multifamily + retail",
    'units': 98,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
    ...
    'subcontract_no': "Dockside Subcontract - 6505",
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2055 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

#!/usr/bin/env python3
"""
parse_2107.py — Parse Job 2107 JDR PDF → 2107_data.json

Structured parse of the 469-page Sage Timberline Job Detail Report for
Job 2107 (Chinn, 68th & Roosevelt). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2107CC · Client: Chinn Construction, LLC · GC: Chinn.
"""
import json
import re
...
# owp-2107-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2107 Job Detail Report.pdf'
OUT = _HERE / '2107_data.json'

PROJECT_META = {
    'job_number': '2107',
    'job_name': '68th & Roosevelt',
    'general_contractor': 'Chinn Construction, LLC',
    'owner': 'TBD',
    'location': '68th & Roosevelt, Seattle, WA',
    ...
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 245731.00,
    'billed_to_date': 4422211.00,
    'chinn_project_number': 'TBD',
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2107"', 'Job Number: 2107',
    'Job Name: Chinn, 68th & Roosevelt', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 469-page 2107 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

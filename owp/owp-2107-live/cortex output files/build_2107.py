#!/usr/bin/env python3
"""
build_2107.py — Build the 17-tab JCR Cortex v2 workbook for Job 2107
(Chinn, 68th & Roosevelt) — live/active project.

Input:   2107_data.json  (from parse_2107.py)
Output:  OWP_2107_JCR_Cortex_v2.xlsx
...
DATA_FILE = _HERE / '2107_data.json'
OUT_FILE = _HERE / 'OWP_2107_JCR_Cortex_v2.xlsx'
...
META_2107 = {
    ...
    'owner': '6716 Roosevelt Owner, LLC / High Street Northwest Development',
    'units': 244,
    'total_fixtures': 0,
    'insurance': 'Standard COI',
    'job_start': 'Jan 2025',
    'expected_completion': 'TBD (active)',
    'architect': 'Weinstein A+U, LLC',
    'mep': 'Robison Engineering, Inc.',
    'location': '6716 Roosevelt Way NE, Seattle, WA 98115',
    'project_type': 'Multi-family apartments (6-story wood-frame)',
    'chinn_project_number': '2107',
    'report_date': 'Apr 3, 2026',
    'billed': 4422211.00,
    'retention': 245731.00,
    'build_date': '2026-04-24',
    'contract_original': 4671538,
    'contract_final': 4889866,
    'executed_co_count': 20,
    'cor_count': 34,
    'rfi_count': 258,
    'asi_count': 15,
    'submittal_count': 184,
    ...
    'pay_app_count': 14,
    'bond_cost': 52500,
    'original_bid': 5098000,
    'negotiated_contract': 4671538,
    'cos': [
        {'co': 1, 'desc': 'COR#08 Plumbing Permit Fees', 'amount': 15729},
        {'co': 2, 'desc': 'COR#01 RFI-012&14 Underground Basin Changes', 'amount': -28000},
        {'co': 3, 'desc': 'COR#03,05,06,09,11 — Sprinkler Standpipe, Hub Drains, Canopy, Re-Review, Floor Drain Credit', 'amount': 16279},
        {'co': 4, 'desc': 'COR#04r1 RFI 36 Updated Plumbing Equipment', 'amount': -3213},
        {'co': 5, 'desc': 'Add Dog Wash', 'amount': 7800},
        {'co': 6, 'desc': 'COR#12 Bond Cost', 'amount': 52500},
        {'co': 7, 'desc': 'COR#13 ASI 006 Credits for Deleted Items', 'amount': -7760},
        {'co': 8, 'desc': 'COR#10 ASI-004 Revised Plumbing Plan Costs', 'amount': 37005},
        {'co': 9, 'desc': 'COR#14,13r1 ASI 007 & ASI 006 Hosebibs/Fixtures', 'amount': 33293},
        {'co': 10, 'desc': 'COR#18,17 RFI 143 Added Condensates & RFI 156 X01 Shut Off', 'amount': 5793},
        {'co': 11, 'desc': 'COR#15 ASI-008 Vent Rerouting', 'amount': 16683},
        {'co': 12, 'desc': 'COR#20,16 RFI 198 Moving Water Main & RFI 137', 'amount': 1231},
        {'co': 13, 'desc': 'COR#22 ASI-011 Changes', 'amount': 35580},
        {'co': 14, 'desc': 'COR#29,28,27,26 Condensate/Rework/AW/Shower Stack', 'amount': 4086},
        {'co': 15, 'desc': 'COR#25 Move Rain Leader', 'amount': 5370},
        {'co': 16, 'desc': 'COR#32,23,19r1 Lower Water Mains/Rerouting/Roof Drains', 'amount': 4054},
        {'co': 17, 'desc': 'COR#31 RFI 211 Rework', 'amount': 3822},
        {'co': 18, 'desc': 'COR#33,21r1 ASI 13 Move Sink & Level 1 Redesign RFI-241', 'amount': 10334},
        {'co': 19, 'desc': 'COR#34r1 Plan Review Fee', 'amount': 628},
        {'co': 20, 'desc': 'COR#36,35 ASI 15 Add Coffee Maker & RFI #258 Repipe Pump Line', 'amount': 7114},
    ],
    'pay_apps': [],
    'change_log': [
        {'date': '2025-01-22', 'type': 'CO', 'ref': 'CO#1', 'desc': 'Plumbing Permit Fees', 'amount': 15729},
        {'date': '2025-02-06', 'type': 'CO', 'ref': 'CO#2', 'desc': 'Underground Basin Changes (RFI-012&14)', 'amount': -28000},
        {'date': '2025-02-25', 'type': 'CO', 'ref': 'CO#3', 'desc': 'Sprinkler/Hub Drains/Canopy/Re-Review/Floor Drain Credit', 'amount': 16279},
        {'date': '2025-03-06', 'type': 'CO', 'ref': 'CO#4', 'desc': 'RFI 36 Updated Plumbing Equipment', 'amount': -3213},
        {'date': '2025-03-12', 'type': 'CO', 'ref': 'CO#5', 'desc': 'Add Dog Wash', 'amount': 7800},
        {'date': '2025-03-19', 'type': 'CO', 'ref': 'CO#6', 'desc': 'Bond Cost', 'amount': 52500},
        {'date': '2025-05-20', 'type': 'CO', 'ref': 'CO#7', 'desc': 'ASI 006 Credits for Deleted Items', 'amount': -7760},
        {'date': '2025-05-22', 'type': 'CO', 'ref': 'CO#8', 'desc': 'ASI-004 Revised Plumbing Plan Costs', 'amount': 37005},
        {'date': '2025-06-12', 'type': 'CO', 'ref': 'CO#9', 'desc': 'ASI 007 Revision & ASI 006 Hosebibs/Fixtures', 'amount': 33293},
        {'date': '2025-08-25', 'type': 'CO', 'ref': 'CO#10', 'desc': 'RFI 143 Added Condensates & RFI 156 X01 Shut Off', 'amount': 5793},
        {'date': '2025-10-07', 'type': 'CO', 'ref': 'CO#11', 'desc': 'ASI-008 Vent Rerouting', 'amount': 16683},
        {'date': '2025-10-30', 'type': 'CO', 'ref': 'CO#12', 'desc': 'RFI 198 Moving Water Main & RFI 137', 'amount': 1231},
        {'date': '2025-11-12', 'type': 'CO', 'ref': 'CO#13', 'desc': 'ASI-011 Changes', 'amount': 35580},
        {'date': '2025-12-05', 'type': 'CO', 'ref': 'CO#14', 'desc': 'Condensate/Rework/AW/Shower Stack', 'amount': 4086},
        {'date': '2025-12-11', 'type': 'CO', 'ref': 'CO#15', 'desc': 'Move Rain Leader', 'amount': 5370},
        {'date': '2026-01-15', 'type': 'CO', 'ref': 'CO#16', 'desc': 'Lower Water Mains/Rerouting/Roof Drains', 'amount': 4054},
        {'date': '2026-01-26', 'type': 'CO', 'ref': 'CO#17', 'desc': 'RFI 211 Rework', 'amount': 3822},
        {'date': '2026-02-05', 'type': 'CO', 'ref': 'CO#18', 'desc': 'ASI 13 Move Sink & Level 1 Redesign RFI-241', 'amount': 10334},
        {'date': '2026-02-11', 'type': 'CO', 'ref': 'CO#19', 'desc': 'Plan Review Fee', 'amount': 628},
        {'date': '2026-04-03', 'type': 'CO', 'ref': 'CO#20', 'desc': 'ASI 15 Add Coffee Maker & RFI #258 Repipe Pump', 'amount': 7114},
    ],
    'predictive_signals': [],
}
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2107.get('retention', 0))
    billed = abs(META_2107.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2107['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2107))
    print(f"Built: {out}")

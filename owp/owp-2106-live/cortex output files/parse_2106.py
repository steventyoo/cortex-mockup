#!/usr/bin/env python3
"""
parse_2106.py — Parse Job 2106 JDR PDF → 2106_data.json

Structured parse of the 15-page Sage Timberline Job Detail Report for
Job 2106 (Chinn, 6220 Roosevelt). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2106CC · Client: Chinn Construction, LLC · GC: Chinn.
"""
import json
import re
...
# owp-2106-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2106 Job Detail Report.pdf'
OUT = _HERE / '2106_data.json'

PROJECT_META = {
    'job_number': '2106',
    'job_name': 'Chinn, 6220 Roosevelt',
    'general_contractor': 'Chinn Construction, LLC',
    'owner': 'TBD',
    'location': '6220 Roosevelt Way NE, Seattle, WA',
    'project_type': 'Multi-family apartments (pre-construction)',
    'units': 146,
    'total_fixtures': 0,
    'architect': 'TBD',
    'mep_engineer': 'Robison Engineering, Inc.',
    ...
    'pay_app_count': 0,
    'duration_months': 0,
    'start_date': 'Jul 2026 (expected)',
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 0,
    'billed_to_date': 49275.00,
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2106"', 'Job Number: 2106',
    'Job Name: Chinn, 6220 Roosevelt', 'Legal:',
...
def main():
    ...
    print(f'  Net profit: ${net_profit:,.2f} ({net_profit/revenue*100:.1f}%)' if revenue else f'  Net profit: ${net_profit:,.2f}')
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 15-page 2106 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

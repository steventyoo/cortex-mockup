#!/usr/bin/env python3
"""
parse_2105.py — Parse Job 2105 JDR PDF → 2105_data.json

Structured parse of the 5-page Sage Timberline Job Detail Report for
Job 2105 (Compass, 3000 Western). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2105CC · Client: Compass General Construction · GC: Compass.
...
# owp-2105-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2105 Job Detail Report.pdf'
OUT = _HERE / '2105_data.json'

PROJECT_META = {
    'job_number': '2105',
    'job_name': 'Compass, 3000 Western',
    'general_contractor': 'Compass General Construction',
    'owner': '3000 Western LLC',
    'location': '3000 Western Ave, Seattle, WA',
    'project_type': 'Multi-family apartments (cancelled)',
    'units': 219,
    'total_fixtures': 0,
    'architect': 'TBD',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2105"', 'Job Number: 2105',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 5-page 2105 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

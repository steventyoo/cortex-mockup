#!/usr/bin/env python3
"""
build_2109.py — Build the 17-tab JCR Cortex v2 workbook for Job 2109
(Compass, 3000 Western) — CANCELLED project.

Input:   2109_data.json  (from parse_2109.py)
Output:  OWP_2109_JCR_Cortex_v2.xlsx
...
DATA_FILE = _HERE / '2109_data.json'
OUT_FILE = _HERE / 'OWP_2109_JCR_Cortex_v2.xlsx'
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2109.get('retention', 0))
    billed = abs(META_2109.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2109['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2109))
    print(f"Built: {out}")

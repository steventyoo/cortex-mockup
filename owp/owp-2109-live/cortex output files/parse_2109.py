#!/usr/bin/env python3
"""
parse_2109.py — Parse Job 2109 JDR PDF → 2109_data.json

Structured parse of the 5-page Sage Timberline Job Detail Report for
Job 2109 (Compass, 3000 Western). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2109CC · Client: Compass General Construction · GC: Compass.
...
# owp-2109-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2109 Job Detail Report.pdf'
OUT = _HERE / '2109_data.json'

PROJECT_META = {
    'job_number': '2109',
    'job_name': "Marysville Ph2",
    'general_contractor': "Intracorp",
    'owner': "Intracorp",
    ...
    'billed_to_date': None,
    'foreman': "Garrett/Mitch",
    'status_note': "Active · ramping up Apr 2026",
    'insurance': 'TBD',
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2109"', 'Job Number: 2109',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 5-page 2109 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

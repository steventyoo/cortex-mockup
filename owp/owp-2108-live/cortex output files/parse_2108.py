#!/usr/bin/env python3
"""
parse_2108.py — Parse Job 2108 JDR PDF → 2108_data.json

Structured parse of the 5-page Sage Timberline Job Detail Report for
Job 2108 (Compass, 3000 Western). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2108CC · Client: Compass General Construction · GC: Compass.
...
# owp-2108-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2108 Job Detail Report.pdf'
OUT = _HERE / '2108_data.json'

PROJECT_META = {
    'job_number': '2108',
    'job_name': "R&G Apartments",
    'general_contractor': "Braseth",
    'owner': "TBD",
    'location': "TBD",
    'project_type': "Multi-family apartments (on-hold · summer 26?)",
    'units': 263,
    'total_fixtures': None,
    'architect': 'TBD',
    'mep_engineer': 'TBD',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2108"', 'Job Number: 2108',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 5-page 2108 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

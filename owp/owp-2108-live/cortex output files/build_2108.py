#!/usr/bin/env python3
"""
build_2108.py — Build the 17-tab JCR Cortex v2 workbook for Job 2108
(Compass, 3000 Western) — CANCELLED project.

Input:   2108_data.json  (from parse_2108.py)
Output:  OWP_2108_JCR_Cortex_v2.xlsx
...
DATA_FILE = _HERE / '2108_data.json'
OUT_FILE = _HERE / 'OWP_2108_JCR_Cortex_v2.xlsx'
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2108.get('retention', 0))
    billed = abs(META_2108.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2108['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2108))
    print(f"Built: {out}")

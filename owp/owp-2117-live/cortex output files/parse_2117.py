#!/usr/bin/env python3
"""
parse_2117.py — Parse Job 2117 JDR PDF → 2117_data.json

Structured parse of the 2-page Sage Timberline Job Detail Report for
Job 2117 (Ravenna Partners, Lachlan Apartments) — 104-unit, 8-story +
penthouse apartment building at 3421 Woodland Park Ave N, Seattle
(Wallingford/Woodland Park neighborhood). Pre-construction / design-DD
phase as of the Apr 3, 2026 JDR snapshot.

Customer code: 2117RP · Client: Ravenna Partners · GC: Ravenna Partners
(owner-GC) · First OWP engagement with Ravenna Partners.
"""
import json
import re
...
# owp-2117-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2117 Job Detail Report.pdf'
OUT = _HERE / '2117_data.json'

PROJECT_META = {
    'job_number': '2117',
    'job_name': 'Lachlan Apartments',
    'general_contractor': 'Ravenna Partners',
    'owner': 'Ravenna Partners',
    'location': '3421 Woodland Park Ave N, Seattle, WA 98103',
    'project_type': '8-story + penthouse studio-apartment building (+ garage + roof deck)',
    'units': 104,                         # 98 Type B + 6 Type A = 104 toilets / units (per job ticket Jan 14 2026)
    'total_fixtures': None,               # TBD — fixture rollup from bid sheet
    'architect': None,                    # TBD
    'mep_engineer': 'Franklin Engineering',  # Lachlan_FEProp doc suggests Franklin
    'report_date': '2026-04-03',
    'contract_original': None,            # Contract value not yet extracted
    'total_cos_net': 0,
    'contract_final': None,
    'executed_co_count': 0,
    'cor_count': 0,
    ...
    'start_date': '2026-02',              # First PR entry ~ Feb 2026 from JDR context
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 0.0,
    'billed_to_date': 0.0,
    'base_bid': None,
    'bid_date': '2026-01-14',             # Job ticket updated Jan 14, 2026
    'bid_labor': None,
    'bid_material': None,
    ...
    'bid_avg_wage': None,
    'insurance': 'Standard (COI)',        # No OCIP specified; Alt #3 offers OCIP deduct
    'tco_date': None,
    'gc_pm': None,
    'gc_pe': None,
    ...
    'water_heating_system': 'Gas (3x 100gal, 199mbh Rinnai/AO Smith/Bock)',  # NOT heat pump
    'first_owp_job_with_ravenna': True,
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2117"', 'Job Number: 2117',
    'Job Name: Ravenna, Lachlan', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 2-page 2117 JDR PDF. Pre-construction / design-DD phase snapshot. Schema matches 2020 gold standard + 2049 v2.2 extensions.',

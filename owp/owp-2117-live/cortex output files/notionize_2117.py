#!/usr/bin/env python3
"""
notionize_2117.py — Build the Notion-styled 2-tab summary workbook for
Job 2117 (Holland, Ballard Blossom) — live project (pre-construction / DD).

Input:   2117_data.json  (from parse_2117.py)
Output:  OWP_2117_JCR_Summary_Notion_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2117_JCR_Summary_Notion_v2.xlsx'
...
if __name__ == "__main__":
    ...
    out = build_notion_workbook(dict(META_2117))
    print(f"Built: {out}")

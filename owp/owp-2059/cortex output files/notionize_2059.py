...
DATA_FILE = _HERE / '2059_data.json'
OUT_FILE = _HERE / 'OWP_2059_JCR_Summary_Notion_v2.xlsx'
...
if __name__ == "__main__":
    data = load_data()
    META_2059['predictive_signals'] = generate_predictive_signals(data)
    out = build_notion_workbook(dict(META_2059))
    print(f"Built: {out}")

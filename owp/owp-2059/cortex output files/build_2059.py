...
OUT_FILE = _HERE / 'OWP_2059_JCR_Cortex_v2.xlsx'
...
META_2059 = {
    ...
    'insurance': "TBD",
    'job_start': "2019-02",
    'expected_completion': "Closed (2020-06)",
    'architect': None,
    'civil': None,
    'structural': None,
    'mep': None,
    ...
    'contract_original': 4378750,
    'contract_final': 4492453,
    'executed_co_count': 0,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2059.get('retention', 0))
    billed = abs(META_2059.get('billed', 0))
...
if __name__ == "__main__":
    ...
    out = build_workbook(dict(META_2059))
    print(f"Built: {out}")

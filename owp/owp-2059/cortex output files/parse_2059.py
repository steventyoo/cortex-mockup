...
# owp-2059/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2059 Job Detail Report.pdf'
OUT = _HERE / '2059_data.json'

PROJECT_META = {
    'job_number': '2059',
    'job_name': "Meeker",
    'general_contractor': "GRE Construction LLC",
    'owner': "GRE",
    'location': "Kent, WA (2030 West Meeker Street)",
    'project_type': "Multi-building multifamily (Buildings A + B + ?)",
    'units': 107,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
    ...
    'subcontract_no': "MasterSubcontract 78472",
    'effective_date': "Feb 27, 2019",
    'insurance': "TBD",
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2059 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

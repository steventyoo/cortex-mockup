...
# owp-2057/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2057 Job Detail Report.pdf'
OUT = _HERE / '2057_data.json'

PROJECT_META = {
    'job_number': '2057',
    'job_name': "Plaza Apartments",
    'general_contractor': "Natural & Built",
    'owner': "Kirkland Sustainable Investments",
    'location': "Kirkland, WA (330 4th Street)",
    'project_type': "SRO-style boutique mixed-use (small kitchen units + shared common areas)",
    'units': 10,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2057 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

...
DATA_FILE = _HERE / '2057_data.json'
OUT_FILE = _HERE / 'OWP_2057_JCR_Cortex_v2.xlsx'
...
META_2057 = {
    ...
    'insurance': "TBD",
    'job_start': "2018",
    'expected_completion': "Closed (2019-10)",
    'architect': None,
    'civil': None,
    'structural': None,
    'mep': None,
    ...
    'contract_original': 1098897,
    'contract_final': 1133967,
    'executed_co_count': 0,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2057.get('retention', 0))
    billed = abs(META_2057.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2057['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2057))
    print(f"Built: {out}")

#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2032 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2032_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2032_Notion_v2.xlsx')
...
# ── Job Info team for 2032 (Blueprint Capital Services Luna Apts-Roosevelt) ─────
TEAM = [
    ("GC",             "Blueprint Capital Services, LLC"),
    ("GC PM",          "Rick (per OWP Project List)"),
    ("GC Superintendent","Andrew Withnell / Scott McSpadden"),
    ("GC PE",          "N/A"),
    ("Developer",      "Blueprint Capital Services"),
    ("Architect",      "N/A"),
    ("Structural",     "N/A"),
    ("Acoustical",     "N/A"),
    ("ADA Consultant", "N/A"),

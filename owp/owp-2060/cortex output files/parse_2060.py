...
# owp-2060/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2060 Job Detail Report.pdf'
OUT = _HERE / '2060_data.json'

PROJECT_META = {
    'job_number': '2060',
    'job_name': "Marina Square",
    'general_contractor': "Compass Construction",
    'owner': "Compass Construction (Marina Square)",
    'location': "Bremerton, WA (280 Washington Ave)",
    'project_type': "Mixed-use 2-tower (Tower 1 = 129 apt units · Tower 2 = 125 former-hotel extended-stay units)",
    'units': 254,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
    'report_date': '2026-04-03',
    'contract_original': None,
    'total_cos_net': None,
    ...
    'subcontract_no': "MSQ Subcontract + SCO #2",
    'effective_date': "2021-2022",
    'insurance': "TBD",
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2060 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

...
DATA_FILE = _HERE / '2060_data.json'
OUT_FILE = _HERE / 'OWP_2060_JCR_Cortex_v2.xlsx'
...
META_2060 = {
    ...
    'name': "Marina Square",
    'short_name': "MSQ",
    'gc': "Compass Construction",
    'owner': "Compass Construction (Marina Square)",
    'units': 254,
    'total_fixtures': None,
    'insurance': "TBD",
    'job_start': "2019",
    'expected_completion': "Closed (2022-07)",
    'architect': None,
    'civil': None,
    'structural': None,
    'mep': None,
    ...
    'contract_original': 5307510,
    'contract_final': 6156577,
    'executed_co_count': 2,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2060.get('retention', 0))
    billed = abs(META_2060.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2060['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2060))
    print(f"Built: {out}")

...
OUT_FILE = _HERE / 'OWP_2058_JCR_Cortex_v2.xlsx'
...
META_2058 = {
    ...
    'contract_original': 928800,
    'contract_final': 961556,
    'executed_co_count': 7,
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2058.get('retention', 0))
    billed = abs(META_2058.get('billed', 0))
...
if __name__ == "__main__":
    ...
    out = build_workbook(dict(META_2058))
    print(f"Built: {out}")

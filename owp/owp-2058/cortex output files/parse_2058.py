...
# owp-2058/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2058 Job Detail Report.pdf'
OUT = _HERE / '2058_data.json'

PROJECT_META = {
    'job_number': '2058',
    'job_name': "Howell Apartments",
    'general_contractor': "Blueprint Capital Services, LLC",
    'owner': "Blueprint",
    'location': "Seattle, WA (600 E Howell Street, Capitol Hill)",
    'project_type': "Multifamily + Live/Work (per CO #07 retail-to-LW conversion)",
    'units': 76,
    'total_fixtures': None,
    'architect': None,
    'mep_engineer': None,
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2058 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

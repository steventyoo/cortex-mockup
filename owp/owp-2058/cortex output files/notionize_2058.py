...
DATA_FILE = _HERE / '2058_data.json'
OUT_FILE = _HERE / 'OWP_2058_JCR_Summary_Notion_v2.xlsx'
...
if __name__ == "__main__":
    data = load_data()
    META_2058['predictive_signals'] = generate_predictive_signals(data)
    out = build_notion_workbook(dict(META_2058))
    print(f"Built: {out}")

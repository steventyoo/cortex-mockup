#!/usr/bin/env python3
"""
parse_2043.py — Parse Job 2043 JDR PDF → 2043_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2043 (Compass Harbor Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2043SH · Client: Boren and Spruce, LLC · GC: Compass Harbor.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2043_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2043_data.json')

PROJECT_META = {
    'job_number': '2043',
    'job_name': 'Compass Aegis-Mercer Isl',
    'general_contractor': 'Compass Harbor',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2043" only', 'Job Number:2043',
    'Job Name: Compass Aegis-Mercer Isl', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2043 JDR PDF. Mirrors Sam v4 test-labels structure.',

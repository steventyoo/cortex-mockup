"""
notionize_2043.py — Build OWP_2043_JCR_Summary_Notion_v2.xlsx

17-tab Notion-styled summary workbook for project #2043 Aegis Mercer Island
(Shelter Holdings / ASC Mercer Island, LLC / 915 E Spruce St, Seattle).

Consumes:
    /sessions/gracious-relaxed-pascal/2043_data.json          (JDR-parsed facts)
    /sessions/gracious-relaxed-pascal/2043_enriched_meta.json (GDrive-enriched meta)

Outputs:
    /sessions/gracious-relaxed-pascal/mnt/cortex-mockup/owp/owp-2043/cortex output files/
        OWP_2043_JCR_Summary_Notion_v2.xlsx
...
DATA_JSON = BASE / '2043_data.json'
META_JSON = BASE / '2043_enriched_meta.json'
OUT_DIR   = BASE / 'mnt' / 'cortex-mockup' / 'owp' / 'owp-2043' / 'cortex output files'
OUT_PATH  = OUT_DIR / 'OWP_2043_JCR_Summary_Notion_v2.xlsx'
...
SRC_JDR  = '2043 Job Detail Report.pdf (Sage Timberline, 04/03/2026)'
SRC_LIST = 'OWP Project List with Schedule - UPDATED 04-01-26.xlsx'
SRC_CNTR = '2043-Shelter Holdings subcontract SC-17-04-022-100-000 + Boren & Spruce CO docs'
...
def build_overview(wb, d, m):
    ...
    hero(ws,
         ...
         f"Cortex JCR v2  •  {meta['general_contractor']} (customer 2043SH)  •  "
    ...
    rows_overview = [
        ...
        ('Project Description',       f"Aegis Mercer Island — {units}-unit 7-story midrise multi-family (4 Type A ADA), Seattle", SRC_LIST + ' + contract'),
        ('General Contractor',        meta['general_contractor'],               SRC_LIST),
        ('Customer Code (Sage)',      '2043SH',                                 SRC_JDR),
        ...
        ('Architect',                 meta['architect'],                        'Aegis Mercer Island project info.pdf'),
    ...
    scope_lines = [
        ...
        f"GC: {meta['general_contractor']} (2043SH); Owner: {meta['owner']}.",
...
def build_po(wb, d, m):
    ...
    rows = [
        ('PRIME',   meta['contract_signed_date'], meta['general_contractor'],
         ...
         f"Aegis Mercer Island plumbing ({meta['units']} units, 7 stories) — per Div 22",
...
def build_insights(wb, d, m, workers_data):
    ...
    rows = [
        ...
        ('INSURANCE',
         ...
         'Verified', SRC_LIST),
        ('SCOPE CONTEXT',
         f"Aegis Mercer Island — {meta['units']}-unit 7-story midrise (68 standard + 4 Type A ADA) + "
...
def _compute_kpis(d, m, workers_data):
    ...
    return [
        ...
        ('Architect',             'architect',        meta['architect'], 'Profile', 'text', '', 'Aegis Mercer Island project info.pdf'),
...
def main():
    ...
    # Fill 2043-specific defaults in case enriched_meta lacks the 2041-style fields
    _m = meta['meta']

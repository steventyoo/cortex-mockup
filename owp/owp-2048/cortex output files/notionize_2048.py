"""
notionize_2048.py — Build OWP_2048_JCR_Summary_Notion_v2.xlsx

17-tab Notion-styled summary workbook for project #2048 GRE Ballinger Apartments
(Shelter Holdings / GRE 205th LLC / 915 E Spruce St, Seattle).

Consumes:
    /sessions/gracious-relaxed-pascal/2048_data.json          (JDR-parsed facts)
    /sessions/gracious-relaxed-pascal/2048_enriched_meta.json (GDrive-enriched meta)

Outputs:
    /sessions/gracious-relaxed-pascal/mnt/cortex-mockup/owp/owp-2048/cortex output files/
        OWP_2048_JCR_Summary_Notion_v2.xlsx
...
DATA_JSON = BASE / '2048_data.json'
META_JSON = BASE / '2048_enriched_meta.json'
OUT_DIR   = BASE / 'mnt' / 'cortex-mockup' / 'owp' / 'owp-2048' / 'cortex output files'
OUT_PATH  = OUT_DIR / 'OWP_2048_JCR_Summary_Notion_v2.xlsx'
...
SRC_JDR  = '2048 Job Detail Report.pdf (Sage Timberline, 04/03/2026)'
SRC_LIST = 'OWP Project List with Schedule - UPDATED 04-01-26.xlsx'
SRC_CNTR = '2048-Shelter Holdings subcontract 7921 + Boren & Spruce CO docs'
...
def build_overview(wb, d, m):
    ...
    hero(ws,
         ...
         f"Cortex JCR v2  •  {meta['general_contractor']} (customer 2048SH)  •  "
    ...
    rows_overview = [
        ...
        ('Project Description',       f"GRE Ballinger Apartments — {units}-unit 7-story midrise multi-family (4 Type A ADA), Seattle", SRC_LIST + ' + contract'),
        ('General Contractor',        meta['general_contractor'],               SRC_LIST),
        ('Customer Code (Sage)',      '2048SH',                                 SRC_JDR),
        ...
        ('Architect',                 meta['architect'],                        'GRE Ballinger Apartments project info.pdf'),
    ...
    scope_lines = [
        ...
        f"GC: {meta['general_contractor']} (2048SH); Owner: {meta['owner']}.",
...
def build_po(wb, d, m):
    ...
    rows = [
        ('PRIME',   meta['contract_signed_date'], meta['general_contractor'],
         ...
         f"GRE Ballinger Apartments plumbing ({meta['units']} units, 7 stories) — per Div 22",
...
def build_insights(wb, d, m, workers_data):
    ...
    rows = [
        ...
        ('INSURANCE',
         ...
         'Verified', SRC_LIST),
        ('SCOPE CONTEXT',
         f"GRE Ballinger Apartments — {meta['units']}-unit 7-story midrise (68 standard + 4 Type A ADA) + "
...
def _compute_kpis(d, m, workers_data):
    ...
    return [
        ...
        ('Architect',             'architect',        meta['architect'], 'Profile', 'text', '', 'GRE Ballinger Apartments project info.pdf'),
...
def main():
    ...
    # Fill 2048-specific defaults in case enriched_meta lacks the 2041-style fields
    _m = meta['meta']

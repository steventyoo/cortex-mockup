#!/usr/bin/env python3
"""
parse_2048.py — Parse Job 2048 JDR PDF → 2048_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2048 (GRE Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2048SH · Client: Boren and Spruce, LLC · GC: GRE.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2048_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2048_data.json')
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2048" only', 'Job Number:2048',
    'Job Name: GRE Ballinger', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2048 JDR PDF. Mirrors Sam v4 test-labels structure.',

#!/usr/bin/env python3
"""
parse_2103.py — Parse Job 2103 JDR PDF → 2103_data.json

Structured parse of the 450-page Sage Timberline Job Detail Report for
Job 2103 (Compass Northgate M2). Mirrors Cortex v2.2 schema so downstream
build/notionize scripts can consume the same shape.

Customer code: 2103CC · Client: Compass General Construction I, LLC
"""
import json
import re
...
# owp-2103-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2103 Job Detail Report.pdf'
OUT = _HERE / '2103_data.json'

PROJECT_META = {
    'job_number': '2103',
    'job_name': 'Northgate Station M2',
    'general_contractor': 'Compass General Construction I, LLC',
    'owner': 'Simon Property Group (Indianapolis, IN)',
    'location': '10523 5th Ave NE, Seattle, WA 98125',
    'project_type': '9-story mixed-use residential (retail + residential)',
    'units': 234,
    'total_fixtures': 1240,
    'architect': 'GGLO',
    'mep_engineer': 'Ecotope',
    'report_date': '2026-04-03',
    'contract_original': 6030791,
    'total_cos_net': 594362.34,
    'contract_final': 6625153.34,
    'executed_co_count': 54,
    'cor_count': 57,
    'cancelled_cor_count': 5,
    'rfi_count': 144,
    'asi_count': 19,
    'submittal_count': 25,
    'total_pos': 56,
    ...
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 305091.57,
    'billed_to_date': 6608301.34,
    'insurance': 'OCIP',
    'subcontract_number': '22-0500-01',
    'gc_project_number': '24-03',
    'ri_foreman': 'Victor/Orlando',
    'trim_foreman': None,
    'gc_pm': 'Scott Paul',
    'gc_pe': 'Logan Brooks',
    'base_bid': 6038000,
    'bid_date': '2023-07-12',
    'previous_plumber': 'SJS (took over mid-project)',
    'invoice_count': 626,
    'vendor_quote_count': 56,
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2103"', 'Job Number: 2103',
    'Job Name: Compass Northgate M2', 'Legal:',
...
def main():
    ...
    print(f'  Net profit: ${net_profit:,.2f} ({net_profit/revenue*100:.1f}%)' if revenue else '  Net profit: $0')
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 450-page 2103 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions.',
        'project': project,
        'totals': totals,
        'labor': labor,
        'report_record': {
            'job_number': '2103',
            'job_name': 'Compass Northgate M2',
            'report_date': '2026-04-03',

#!/usr/bin/env python3
"""
build_2103.py — Build the 17-tab JCR Cortex v2 workbook for Job 2103
(Compass Northgate M2) — live/active project.

Input:   2103_data.json  (from parse_2103.py)
Output:  OWP_2103_JCR_Cortex_v2.xlsx
"""
import json
...
OUT_FILE = _HERE / 'OWP_2103_JCR_Cortex_v2.xlsx'
...
def generate_predictive_signals(data):
    ...
    ret = abs(META_2103.get('retention', 0))
    billed = abs(META_2103.get('billed', 0))
...
if __name__ == "__main__":
    ...
    out = build_workbook(dict(META_2103))
    print(f"Built: {out}")

#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2027 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2027_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2027_Notion_v2.xlsx')
...
# ── Job Info team for 2027 (Exxel 550 Broadway / Zig) ─────
TEAM = [

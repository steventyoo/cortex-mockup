#!/usr/bin/env python3
"""Build OWP_2025 Cortex v2 17-tab JCR. Exxel Pacific Cora Apts / 19 W Harrison, Seattle.
...
data = json.load(open('/sessions/keen-determined-mccarthy/work/2025_data.json'))
CODES = data['codes']
...
JOB = "2025"
NAME = "Exxel Pacific Cora Apts"
PROJECT_DESC = "The Cora Apartments @ 19 W Harrison St, Seattle, WA 98109 — new construction plumbing"
GC = "Exxel Pacific, Inc."
GC_CUST_CODE = "2025EP"
OWNER = "19 W HARRISON LLC"

# Financial (JDR footer)
REVENUE = 1_208_338.00
EXPENSES = 746_934.31
NET_PROFIT = 461_403.69
RETAINAGE = 60_416.90
SRC_GL = 38_463.57
SRC_AP = 271_893.26
SRC_PR = 436_577.48

CONTRACT_ORIG = 1_179_300.00
CONTRACT_FINAL = 1_208_338.00
...
SRC_JDR = "2025 Job Detail Report.pdf (Sage Timberline, 04/03/2026, 126 pages)"
...
SRC_PTAG = "19 W Harrison working copy of P-tag list  front page detail.xlsx"
SRC_NARRATIVE = "19 W Harrison plumbing narrative.pdf"
SRC_FOLDER = "owp-2025/"
...
title(ws, f"Job #{JOB} · {NAME} — The Cora Apartments",
      f"Cortex JCR Cortex v2  •  {GC} (customer {GC_CUST_CODE})  •  19 W Harrison St, Seattle WA 98109  •  Owner: {OWNER}")
put(ws, "B5", "PROJECT OVERVIEW", BOLD, F_ALT)
overview = [
    ("Project Job #", JOB, SRC_JDR + " header"),
    ("Project Name (Sage)", NAME, SRC_JDR + " header"),
    ("Project Description", "The Cora Apartments — 19 W Harrison St, Seattle", SRC_CONTRACT + " / AR line descriptions"),
    ("General Contractor", GC, SRC_CONTRACT),
    ("Customer Code (Sage)", GC_CUST_CODE, SRC_JDR),
    ("Owner / Developer", OWNER, SRC_CONTRACT),
    ("Jobsite Location", "19 W Harrison St, Seattle, WA 98109", SRC_CONTRACT),
...
put(ws, f"G{r}", "The Cora Apts plumbing (19 W Harrison, Seattle) — full scope per proposal + narrative", align=LEFT)
...
kpis = [
    ...
    ("Project Description", "project_desc", "The Cora Apartments @ 19 W Harrison St, Seattle", "Profile", "Contract + AR lines", "Verified", SRC_CONTRACT),
    ...
    ("Location", "location", "19 W Harrison St, Seattle, WA 98109", "Profile", "Contract address", "Verified", SRC_CONTRACT),
...
metrics = [
    ...
    ("project_desc", "Project Description", "The Cora Apts @ 19 W Harrison", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
    ...
    ("location", "Location", "19 W Harrison St, Seattle WA 98109", "text", "Benchmark KPIs", "Verified", SRC_CONTRACT),
...
src_lines = [
    ...
    f"Contract: {SRC_CONTRACT} (Lump Sum ${CONTRACT_ORIG:,.2f} to {OWNER}, 19 W Harrison)",

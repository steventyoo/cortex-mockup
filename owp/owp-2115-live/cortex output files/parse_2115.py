#!/usr/bin/env python3
"""
parse_2115.py — Parse Job 2115 JDR PDF → 2115_data.json

Structured parse of the 3-page Sage Timberline Job Detail Report for
Job 2115 (Chinn, Elowen Apartments) — 2-building multifamily in Lake
Stevens, WA. Chinn's 7th OWP project (after #2009/#2010/#2011/#2023/
#2041/#2098). Pre-construction / design-DD phase as of the Apr 3, 2026
JDR snapshot. Mirrors Cortex v2.2 schema so downstream build/notionize
scripts can consume the same shape.

Customer code: 2115CC · Client: Chinn Construction, LLC · GC: Chinn
(Charlie Poggemann, PM).
"""
import json
import re
...
# owp-2115 live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2115 Job Detail Report.pdf'
OUT = _HERE / '2115_data.json'

PROJECT_META = {
    'job_number': '2115',
    'job_name': 'Elowen Apartments',
    'general_contractor': 'Chinn Construction, LLC',
    'owner': 'North Cove Investors, LLC (Seattle, WA)',
    'location': 'Lake Stevens, WA',
    'project_type': '2-building multifamily (Bldg A + Bldg B)',
    'units': None,                      # TBD — bid sheet references but not captured yet
    'total_fixtures': None,
    'architect': None,                  # TBD
    'mep_engineer': 'One Way Plumbing (design-build; plumbing 2-D CAD)',
    'report_date': '2026-04-03',
    'contract_original': 3945000,       # Base bid: $2,804,400 Bldg A + $1,060,200 Bldg B (plumbing construction)
    'total_cos_net': 0,
    'contract_final': 3945000,
    'executed_co_count': 0,
    'cor_count': 0,
    ...
    'total_pos': 0,
    'permit_count': 0,
    'pay_app_count': 0,                 # Design billing only — see invoice_count below
    'duration_months': None,            # TBD — schedule not published in bid
    'start_date': '2026-02',            # First Sage PR entry (takeoff labor Gerard, Feb 13 2026)
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 0.0,
    'billed_to_date': 0.0,              # No AR billings yet; expenses only
    'base_bid': 3945000,
    'bid_date': '2025-09-24',           # Original plumbing budget proposal to Chinn
    'bid_labor': None,                  # Not broken out in budget-proposal format
    'bid_material': None,
    'bid_subcontractor_other': None,
    'bid_overhead_profit_pct': None,
    'bid_total_hours': None,
    'bid_avg_wage': None,
    'design_fee_total': 80400,          # $55,600 Bldg A + $24,800 Bldg B (design/engineering only)
    'design_fee_bldg_a': 55600,
    'design_fee_bldg_b': 24800,
    'construction_bldg_a': 2804400,
    'construction_bldg_b': 1060200,
    'insurance': 'Standard (COI)',
    'tco_date': None,
    'gc_pm': 'Charlie Poggemann',
    'gc_pe': None,
    ...
    'owner_poc': 'Tejal Pastakia',
    'owner_signatory': 'Matthew Burton (Manager)',
    'design_proposal_signed': '2025-12-03',
    'chinn_job_number': 7,               # 7th OWP Chinn engagement (after 2009/2010/2011/2023/2041/2098)
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2115"', 'Job Number: 2115',
    'Job Name: Chinn, Elowen Apts', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 3-page 2115 JDR PDF. Pre-construction / design-DD phase snapshot (7th Chinn job for OWP). Schema matches 2020 gold standard + 2049 v2.2 extensions.',

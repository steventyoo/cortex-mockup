#!/usr/bin/env python3
"""
build_2115.py — Build the 17-tab JCR Cortex v2 workbook for Job 2115
(Holland, Ballard Blossom) — live/active project (pre-construction / DD phase).

Input:   2115_data.json  (from parse_2115.py)
Output:  OWP_2115_JCR_Cortex_v2.xlsx
...
DATA_FILE = _HERE / '2115_data.json'
OUT_FILE = _HERE / 'OWP_2115_JCR_Cortex_v2.xlsx'
...
META_2115 = {
    'job_id': '2115',
    'name': 'Elowen Apartments',
    'short_name': 'Elowen',
    'gc': 'Chinn Construction, LLC',
    'owner': 'North Cove Investors, LLC (Seattle, WA)',
    'units': None,                          # TBD
    'total_fixtures': None,                 # TBD
    'insurance': 'Standard (COI)',
    'job_start': 'Feb 2026',                # first Sage PR entry (takeoff Feb 13 2026)
    'expected_completion': 'TBD — schedule not published in budget proposal',
    'architect': None,
    'mep': 'One Way Plumbing (design-build, 2-D CAD)',
    'location': 'Lake Stevens, WA',
    'project_type': '2-building multifamily (Bldg A + Bldg B)',
    'subcontract_number': None,             # Not yet filed to Drive
    'gc_project_number': None,
    'report_date': 'Apr 3, 2026',
    'billed': 0.0,                          # No AR yet
    'retention': 0.0,
    'build_date': '2026-04-24',
    'contract_original': 3945000,           # $2.8M Bldg A + $1.06M Bldg B (plumbing construction)
    ...
    'ri_foreman': None,
    'trim_foreman': None,
    'gc_pm': 'Charlie Poggemann',           # Chinn PM
    'gc_pe': None,
    'owp_vp': 'Richard Donelson',
    'previous_plumber': None,
    'invoice_count': None,
    'vendor_quote_count': None,
    # Project economics (from Sept 24 2025 budget proposal)
    'design_fee_total': 80400,              # $55,600 Bldg A + $24,800 Bldg B
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2115.get('retention', 0))
    billed = abs(META_2115.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2115['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2115))
    print(f"Built: {out}")

#!/usr/bin/env python3
"""
parse_2042.py — Parse Job 2042 JDR PDF → 2042_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2042 (Shelter Holdings Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2042SH · Client: Boren and Spruce, LLC · GC: Shelter Holdings.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2042_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2042_data.json')

PROJECT_META = {
    'job_number': '2042',
    'job_name': 'ShelterHoldings MetroLine',
    'general_contractor': 'Shelter Holdings',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2042" only', 'Job Number:2042',
    'Job Name: ShelterHoldings MetroLine', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2042 JDR PDF. Mirrors Sam v4 test-labels structure.',

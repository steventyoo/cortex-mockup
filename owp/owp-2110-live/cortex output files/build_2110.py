#!/usr/bin/env python3
"""
build_2110.py — Build the 17-tab JCR Cortex v2 workbook for Job 2110
(Compass, 3000 Western) — CANCELLED project.

Input:   2110_data.json  (from parse_2110.py)
Output:  OWP_2110_JCR_Cortex_v2.xlsx
...
DATA_FILE = _HERE / '2110_data.json'
OUT_FILE = _HERE / 'OWP_2110_JCR_Cortex_v2.xlsx'
...
META_2110 = {
    'job_id': '2110',
    'name': "Roosevelt Manor",
    'short_name': "Roosevelt Manor",
    'owner': 'TBD',
    'gc': "Sierra",
    'units': 137,
    'total_fixtures': None,
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2110.get('retention', 0))
    billed = abs(META_2110.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2110['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2110))
    print(f"Built: {out}")

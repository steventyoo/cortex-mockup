...
# owp-2061/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2061 Job Detail Report.pdf'
OUT = _HERE / '2061_data.json'

PROJECT_META = {
    'job_number': '2061',
    'job_name': 'Alta Columbia City',
    'general_contractor': 'Exxel Pacific',
    'owner': 'Gateway Alta Rainer Owner, LLC',
    'location': 'Seattle, WA (3717 South Alaska Street, Columbia City)',
    'project_type': '243-unit mixed-use multifamily + 6 retail spaces',
    'units': 243,
    'total_fixtures': None,
    'architect': 'Johnston Architects, PLLC',
    'mep_engineer': 'Rushing Engineering',
    'report_date': '2026-04-03',
    'contract_original': 4305550,
    'total_cos_net': None,
    'contract_final': 4430088,
    'executed_co_count': 17,
    'cor_count': None,
    ...
    'end_date': '2022-05',
    'retention_rate': 0.05,
    'retention_amount': 221504.39,
    'billed_to_date': 4430088,
    'subcontract_no': 'L1.220000 / Phase Code L1.220000S',
    'effective_date': '2019-06-21',
    'insurance': 'OCIP / WRAP — see WRAP job budget',
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2061 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

#!/usr/bin/env python3
"""
parse_2051.py — Parse Job 2051 JDR PDF → 2051_data.json

Structured parse of the 201-page Sage Timberline Job Detail Report for
Job 2051 (Compass, Vail Apartments) — 163-unit closed/completed project
in Bellevue area. Started Mar 2018, completed (retention released 2023).
Mirrors Cortex v2.2 schema (matching 2020 gold standard) so downstream
build/notionize scripts can consume the same shape.

Customer code: 2051CC · Client: Compass Construction · GC: Compass ·
Owner: AAA Management.
"""
import json
import re
...
# owp-2052/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2052 Job Detail Report.pdf'
OUT = _HERE / '2052_data.json'

PROJECT_META = {
    'job_number': '2052',
    'job_name': 'Fifth & Roy',
    'general_contractor': 'Farrell-McKenna Construction LLC',
    'owner': 'Fifth North & Roy LLC',
    'location': 'Lower Queen Anne, Seattle, WA (701 5th Ave N)',
    'project_type': 'Mixed-use multifamily + retail (Blarney Stone restaurant)',
    'units': 107,                             # 107 dishwashers/icemakers/washers per Job Ticket 7-25-2019
    'total_fixtures': None,                   # ~118 toilets + 118 lavs + 115 tub/showers + 107 kitchen sinks
    'architect': 'Hewitt Architects',
    'civil_engineer': 'KPFF Consulting Engineers',
    'structural_engineer': 'Bykonen Carter Quinn',
    'mep_engineer': 'Rushing Engineering',    # Per "Rushing drawings" reference in Job Ticket
    'report_date': '2026-04-03',
    'contract_original': 2134000,             # Per executed contract (Item 22-0000 Plumbing)
    'total_cos_net': None,                    # Computed from JDR (final 2,231,035 - 2,134,000 = +97,035)
    'contract_final': 2231035,                # Per JDR Job Totals revenue
    'executed_co_count': None,
    'cor_count': None,
    'cancelled_cor_count': None,
    'rfi_count': None,
    'asi_count': None,
    'submittal_count': None,
    'total_pos': None,
    'permit_count': None,
    'pay_app_count': None,
    'duration_months': 22,                    # Per JDR (Mar 2018 first PR → Dec 2019 last AR)
    'start_date': '2018-02',                  # Contract effective Feb 9, 2018; first PR Mar 23, 2018
    'end_date': '2019-12',                    # Last AR invoice Dec 19, 2019
    'retention_rate': 0.05,
    'retention_amount': 111551.75,            # Per JDR (held)
    'billed_to_date': 2231035,
    'gc_pm': None,                            # TBD from GDrive Meeting Minutes
    'gc_sup': None,
    'gc_pe': None,
    'ri_foreman': None,                       # TBD
    'insurance': 'Not Wrap (Bond Not Required per contract)',
    'subcontract_no': '22-0000 (Project #17-100)',
    'effective_date': '2018-02-09',
    'farrell_job_position': 'First (and only) OWP × Farrell-McKenna engagement in closed portfolio',
}
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2051"', 'Job Number: 2051',
    'Job Name: Chinn, Trailside 2', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 171-page 2052 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (last AR Dec 2019).',

...
text = open('/sessions/keen-determined-mccarthy/work/2023_jdr.txt').read()
lines = text.split('\n')
...
with open('/sessions/keen-determined-mccarthy/work/2023_data.json', 'w') as f:
    json.dump(out, f, indent=2, default=str)
print("Saved /sessions/keen-determined-mccarthy/work/2023_data.json")

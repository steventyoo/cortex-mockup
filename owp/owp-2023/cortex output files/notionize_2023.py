#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2023 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2023_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2023_Notion_v2.xlsx')
...
# ── Job Info team for 2023 (Exxel Project 2023 / 2023) ─────
TEAM = [

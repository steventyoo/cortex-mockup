#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2028 Cortex v2 workbook (17 tabs)
...
SRC = Path('/sessions/keen-determined-mccarthy/work/OWP_2028_JCR_Cortex_v2.xlsx')
OUT = Path('/sessions/keen-determined-mccarthy/work/OWP_2028_Notion_v2.xlsx')
...
# ── Job Info team for 2028 (Exxel Pacific Reserve @ Lynnwood) ─────
TEAM = [
    ("GC",             "Exxel Pacific, Inc."),
    ("GC PM",          "TJ Mellema / Coby Jones"),
    ("GC Superintendent","Brad Holz"),
    ("GC PE",          "N/A"),
    ("Developer",      "AVS Communities"),
    ("Architect",      "Charles Morgan & Associates, LLC"),
    ("Structural",     "N/A"),
    ("Acoustical",     "N/A"),
    ("ADA Consultant", "N/A"),
    ("Interior Design","N/A"),

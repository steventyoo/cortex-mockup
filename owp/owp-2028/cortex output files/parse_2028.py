...
text = open('/sessions/keen-determined-mccarthy/work/2028_jdr.txt').read()
lines = text.split('\n')
...
with open('/sessions/keen-determined-mccarthy/work/2028_data.json', 'w') as f:
    json.dump(out, f, indent=2, default=str)
print("Saved /sessions/keen-determined-mccarthy/work/2028_data.json")

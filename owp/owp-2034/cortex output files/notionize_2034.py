#!/usr/bin/env python3
"""Apply Notion styling to freshly-built OWP_2034 Cortex v2 workbook (17 tabs)
...
SRC = HERE / 'OWP_2034_JCR_Cortex_v2.xlsx'
OUT = HERE / 'OWP_2034_JCR_Summary_Notion_v2.xlsx'
...
# ── Job Info team for 2034 (Compass Park Lane) ─────
TEAM = [
    ("GC",               "Compass Harbor Construction, LLC"),
    ("GC PM",            "Compass Harbor PM (TBD)"),
    ("GC Superintendent","Compass Harbor Sup (TBD)"),
    ("GC PE",            "Compass Harbor PE (TBD)"),
    ("Developer",        "Compass"),
    ("Owner",            "Kirkland Main Street LP"),
    ("Architect",        "N/A"),
    ("Structural",       "N/A"),
    ("Acoustical",       "N/A"),
    ("ADA Consultant",   "N/A"),
    ...
    ("MEP Engineer",     "N/A"),
    ("Insurance",        "Wrap (OCIP)"),
    ("OWP RI Foreman",   "Thaddeus Waites"),
]
...
# Inject Project Team on Overview
ov = wb['Overview']
last_r = ov.max_row
start = last_r + 3

#!/usr/bin/env python3
"""
parse_2044.py — Parse Job 2044 JDR PDF → 2044_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2044 (Blueprint Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2044SH · Client: Boren and Spruce, LLC · GC: Blueprint.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2044_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2044_data.json')

PROJECT_META = {
    'job_number': '2044',
    'job_name': 'Blueprint Track 66 Apts',
    'general_contractor': 'Blueprint',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2044" only', 'Job Number:2044',
    'Job Name: Blueprint Track 66 Apts', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2044 JDR PDF. Mirrors Sam v4 test-labels structure.',

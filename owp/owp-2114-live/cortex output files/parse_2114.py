#!/usr/bin/env python3
"""
parse_2114.py — Parse Job 2114 JDR PDF → 2114_data.json

Structured parse of the 12-page Sage Timberline Job Detail Report for
Job 2114 (Holland, Ballard Blossom) — 239-unit, 8-story apartment +
retail, Seattle Ballard. Pre-construction / design-development phase
as of the Apr 3, 2026 JDR snapshot. Mirrors Cortex v2.2 schema so
downstream build/notionize scripts can consume the same shape.

Customer code: 2114HC · Client: Holland Construction · GC: Holland (new
GC for OWP; first plumbing engagement).
"""
import json
import re
...
# owp-2114-live/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2114 Job Detail Report.pdf'
OUT = _HERE / '2114_data.json'

PROJECT_META = {
    'job_number': '2114',
    'job_name': 'Ballard Blossom Apartments',
    'general_contractor': 'Holland Construction',
    'owner': None,  # TBD — Tatemono-Metzler signals an owner group; confirm on execution of subcontract
    'location': '1734 NW Market St, Seattle, WA 98107',
    'project_type': '8-story + partially sunken basement multifamily + retail',
    'units': 239,
    'total_fixtures': 1368,           # roughin fixture count from bid sheet (1,368 RI / 1,788 permit fixtures)
    'architect': None,                # TBD — not captured in Drive search
    'mep_engineer': 'Robison Engineering',
    'report_date': '2026-04-03',
    'contract_original': 5670000,     # Total bid price (reduced Apr/May 2025); base bid = contract
    'total_cos_net': 0,
    'contract_final': 5670000,
    'executed_co_count': 0,
    'cor_count': 0,
    'cancelled_cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
    'submittal_count': 1,             # Preliminary submittal 2025-07-31
    'total_pos': 2,                   # Pacific 53729 GW PVC + 53731 Roof PVC (Mar 2026)
    'permit_count': 0,
    'pay_app_count': 1,                # Single $80,000 AR on design billing
    'duration_months': 22,             # Per bid sheet schedule (Jul 2026 foundations → Apr 2028 TCO)
    'start_date': '2025-09',           # First Sage PR entry (takeoff labor, Gerard, Jeffrey S)
    'end_date': None,
    'retention_rate': 0.05,
    'retention_amount': 0.0,           # No retention yet (design billing only)
    'billed_to_date': 80000.00,
    'base_bid': 5670000,
    'bid_date': '2025-05-28',          # "reduced price" bid sheet date
    'bid_labor': 1372396,
    'bid_material': 2433141,
    'bid_subcontractor_other': 335160,
    'bid_overhead_profit_pct': 16.22,
    'bid_total_hours': 30712,
    'bid_avg_wage': 43.13,
    'insurance': 'OCIP (WRAP) — assumed by Owner',
    'tco_date': '2028-04-13',          # Per bid schedule tail
    'gc_pm': None,                     # Drew Schemchuck mentioned in bid notes (Holland PM?)
    'gc_pe': None,                     # Michael Ricci mentioned in bid notes (Holland?)
    'gc_project_number': None,
    'ri_foreman': None,                # TBD — still in design/takeoff phase
    'trim_foreman': None,
    'owp_vp': 'Richard Donelson',
    'previous_plumber': None,
    'invoice_count': None,             # Filled from parsed AP line_items
...
PAGE_HDR_MARKERS = (
    'OWP, LLC', 'Job Detail Report', 'for Job "2114"', 'Job Number: 2114',
    'Job Name: Holland, Ballard Blossom', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 12-page 2114 JDR PDF. Pre-construction / design-development phase snapshot. Schema matches 2020 gold standard + 2049 v2.2 extensions.',
        ...
        'report_record': {
            'job_number': '2114',
            'job_name': 'Holland, Ballard Blossom',
            'report_date': '2026-04-03',

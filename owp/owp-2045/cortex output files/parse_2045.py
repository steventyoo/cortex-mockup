#!/usr/bin/env python3
"""
parse_2045.py — Parse Job 2045 JDR PDF → 2045_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2045 (GRE Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2045SH · Client: Boren and Spruce, LLC · GC: GRE.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2045_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2045_data.json')

PROJECT_META = {
    'job_number': '2045',
    'job_name': 'GRE Notch Apartments',
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2045" only', 'Job Number:2045',
    'Job Name: GRE Notch Apartments', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2045 JDR PDF. Mirrors Sam v4 test-labels structure.',

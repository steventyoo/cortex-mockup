"""
notionize_2049.py — Build OWP_2049_JCR_Summary_Notion_v2.xlsx

17-tab Notion-styled summary workbook for project #2049 Exxel Lynnwood Reserve Rebuild Apartments
(Shelter Holdings / Reserve at Lynnwood LP / 915 E Spruce St, Seattle).

Consumes:
    /sessions/gracious-relaxed-pascal/2049_data.json          (JDR-parsed facts)
    /sessions/gracious-relaxed-pascal/2049_enriched_meta.json (GDrive-enriched meta)

Outputs:
    /sessions/gracious-relaxed-pascal/mnt/cortex-mockup/owp/owp-2049/cortex output files/
        OWP_2049_JCR_Summary_Notion_v2.xlsx
...
DATA_JSON = BASE / '2049_data.json'
META_JSON = BASE / '2049_enriched_meta.json'
OUT_DIR   = BASE / 'mnt' / 'cortex-mockup' / 'owp' / 'owp-2049' / 'cortex output files'
OUT_PATH  = OUT_DIR / 'OWP_2049_JCR_Summary_Notion_v2.xlsx'
...
SRC_JDR  = '2049 Job Detail Report.pdf (Sage Timberline, 04/03/2026)'
SRC_LIST = 'OWP Project List with Schedule - UPDATED 04-01-26.xlsx'
SRC_CNTR = '2049-Shelter Holdings subcontract 201506ONELLC + Boren & Spruce CO docs'
...
def build_overview(wb, d, m):
    ...
    hero(ws,
         ...
         f"Cortex JCR v2  •  {meta['general_contractor']} (customer 2049SH)  •  "
    ...
    rows_overview = [
        ...
        ('Project Description',       f"Exxel Lynnwood Reserve Rebuild Apartments — {units}-unit 7-story midrise multi-family (16 Type A ADA), Lynnwood", SRC_LIST + ' + contract'),
        ('General Contractor',        meta['general_contractor'],               SRC_LIST),
        ('Customer Code (Sage)',      '2049SH',                                 SRC_JDR),
        ...
        ('Architect',                 meta['architect'],                        'Exxel Lynnwood Reserve Rebuild Apartments project info.pdf'),
    ...
    scope_lines = [
        ...
        f"GC: {meta['general_contractor']} (2049SH); Owner: {meta['owner']}.",
...
def build_po(wb, d, m):
    ...
    rows = [
        ('PRIME',   meta['contract_signed_date'], meta['general_contractor'],
         ...
         f"Exxel Lynnwood Reserve Rebuild Apartments plumbing ({meta['units']} units, 7 stories) — per Div 22",
...
def build_insights(wb, d, m, workers_data):
    ...
    rows = [
        ...
        ('INSURANCE',
         ...
         'Verified', SRC_LIST),
        ('SCOPE CONTEXT',
         f"Exxel Lynnwood Reserve Rebuild Apartments — {meta['units']}-unit 7-story midrise (279 standard + 16 Type A ADA) + "
...
def _compute_kpis(d, m, workers_data):
    ...
    return [
        ...
        ('Architect',             'architect',        meta['architect'], 'Profile', 'text', '', 'Exxel Lynnwood Reserve Rebuild Apartments project info.pdf'),
...
def main():
    ...
    # Fill 2049-specific defaults in case enriched_meta lacks the 2041-style fields
    _m = meta['meta']

#!/usr/bin/env python3
"""
parse_2049.py — Parse Job 2049 JDR PDF → 2049_data.json

Structured parse of the 94-page Sage Timberline Job Detail Report for
Job 2049 (GRE Metro Line Flats). Mirrors Sam's v4 Test-Labels
schema field-for-field so downstream Cortex builders can consume the same shape.

Customer code: 2049SH · Client: Boren and Spruce, LLC · GC: GRE.
"""
import json
import re
...
PDF = Path('/sessions/gracious-relaxed-pascal/2049_Job_Detail_Report.pdf')
OUT = Path('/sessions/gracious-relaxed-pascal/2049_data.json')
...
PAGE_HDR_MARKERS = (
    'OWP, LLC Page:', 'Job Detail Report', 'for Job "2049" only', 'Job Number:2049',
    'Job Name: Exxel Pacific Reserve', 'Legal:',
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 94-page 2049 JDR PDF. Mirrors Sam v4 test-labels structure.',

...
DATA_FILE = _HERE / '2051_data.json'
OUT_FILE = _HERE / 'OWP_2051_JCR_Cortex_v2.xlsx'
...
META_2051 = {
    ...
    'insurance': 'Not Wrap',
    'job_start': 'Mar 2018',
    'expected_completion': 'Closed (retention released 2023)',
    'architect': None,
    'mep': 'Franklin Engineering',
    'location': 'Bellevue area, WA',
    'project_type': '163-unit multifamily',
    'gc_project_number': None,
    'report_date': 'Apr 3, 2026',
    'billed': 2588280,
    'retention': 126113.98,                  # Held per JDR (note: small + held — possibly disputed/aged)
    'build_date': '2026-04-25',
    'contract_original': 2672000,
    'contract_final': 2588280,
    'executed_co_count': 0,                  # TBD — CO log not yet captured from GDrive
    'cor_count': 0,
    'rfi_count': 0,
    'asi_count': 0,
    'submittal_count': 0,
    ...
    'ri_foreman': 'Bob',
    'cos': [
        # CO log not yet captured from GDrive — JDR shows net $-83,720 (negative growth, which is unusual)
        # Negative CO net suggests credit changes or backcharges netting against scope additions
    ],
    'pay_apps': [],
    'change_log': [],
    'predictive_signals': [
...
def generate_predictive_signals(data):
    ...
    # Retention
    ret = abs(META_2051.get('retention', 0))
    billed = abs(META_2051.get('billed', 0))
...
if __name__ == "__main__":
    data = load_data()
    META_2051['predictive_signals'] = generate_predictive_signals(data)
    out = build_workbook(dict(META_2051))
    print(f"Built: {out}")

...
# owp-2051/cortex output files/ → owp/ → Gemini Accounting Reports/
PDF = _HERE.parent.parent / 'Gemini Accounting Reports' / '2051 Job Detail Report.pdf'
OUT = _HERE / '2051_data.json'

PROJECT_META = {
    'job_number': '2051',
    'job_name': 'Vail Apartments',
    'general_contractor': 'Compass',
    'owner': 'AAA Management',
    'location': 'Bellevue area, WA',         # Address TBD — not captured in OWP Project List
    'project_type': '163-unit multifamily',
    'units': 163,
    'total_fixtures': None,                  # TBD from bid sheet
    'architect': None,
    'mep_engineer': 'Franklin Engineering',  # Per "Franklin Vail Apartments" GDrive folder
    'report_date': '2026-04-03',
    'contract_original': 2672000,            # Per OWP Project List
    'total_cos_net': None,                   # Computed from JDR (revenue 2,588,280 - 2,672,000 = -83,720)
    'contract_final': 2588280,               # Per JDR Job Totals revenue
    ...
    'permit_count': None,
    'pay_app_count': None,
    'duration_months': 22,                    # Per OWP Project List schedule (GW → PT → 8x RI → 4x TRIM + COVID + 2x TRIM)
    'start_date': '2018-03',                  # First Sage PR entry (Mar 23, 2018)
    'end_date': '2023',                       # Closed/retention released
    'retention_rate': 0.05,
    'retention_amount': 126113.98,            # Per JDR (held)
    'billed_to_date': 2588280,
    'gc_pm': 'Justin Anderson',
    'gc_sup': 'Will Fenton',
    'gc_pe': 'Jeff Seeb',
    'ri_foreman': 'Bob',
    'insurance': 'Not Wrap',
    'compass_job_position': 'Compass closed-project portfolio (joining #2033 Vuecrest, #2034 Park Lane, #2038 2nd & John, #2050 2100 E Madison)',
}
...
def main():
    ...
    data = {
        'schema': 'CORTEX_V2.2',
        'schema_note': 'Parsed direct from 201-page 2051 JDR PDF. Schema matches 2020 gold standard + 2049 v2.2 extensions. Closed/completed project (retention released 2023).',

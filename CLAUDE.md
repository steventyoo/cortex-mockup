...
## #2081 Compass 400 Queen Anne + #2082 GRE Northgate Ph II (added 2026-04-29)

- **#2081 Compass General, 400 Queen Anne** (Seattle WA · 400 Queen Anne Ave N · Lower Queen Anne / Uptown · 150-unit mixed-use multifamily · 1,100 fixtures · $2,461,723 final / $2,409,160 base / **15 executed COs net $0** — Mechanism A: $2.95M gross + $488k credits = +19.8% gross over (between #2078's +28.3% and #2076's +1.2%) · **25.0% gross margin — second-lowest in OWP closed Compass portfolio** after #2078 23.8% · $614,697 net profit · 45 workers / 19,936 hrs / 26 months Mar 2021 → May 2023 · Subcontract **2101-2201** executed 2021-03 · GC Compass · Owner 400 Queen Anne LP (Bellevue WA) · Architect **GroupArchitect** (new architect — not previously in closed portfolio) · MEP **Emerald City Engineers** — **2nd consecutive Compass closed job with non-Franklin MEP** (after #2080) · Insurance OCIP (Hub International / Middlesex Policy #207548-00) · top vendor **Keller Supply 32.7% / 52 invoices / $251,542** with Rosen 26.6% and Consolidated 17.1% — Keller-led continues · 16 vendors total, $770,114 AP across 455 invoices · **122 RFIs / 5 submittals — HIGHEST RFI count in OWP closed portfolio** (next-highest is #2069 Theory U-D at 78); inverted ratio (RFI-heavy / submittal-light) suggests heavy field clarification load on this job · retention $119,971 still held).

- **#2082 GRE Construction, Northgate Phase II** (Seattle WA · 10712 5th Ave NE · Northgate · 257-unit multifamily · 1,500 fixtures · $3,565,946 final / $3,513,720 base + design/permit / **12 executed COs net $0** — **TRUE Mechanism B** (zero AR credits) — third closed job to use this posture (after #2067 GRE Edmonds 99 and #2080 Compass Redmond Square) · **25.7% gross margin — LOWEST in OWP\'s closed GRE portfolio** (history: #2045 46.1% → #2048 43.0% → #2047 33.8% → #2059 32.9% → #2067 29.8% → #2082 25.7%; **GRE margin trend is consistently softening over time** — worth investigating whether GRE bid pricing has tightened or scope complexity has increased) · $916,692 net profit · 82 workers / 33,224 hrs / 33 months Jul 2021 → Apr 2024 · Subcontract **7900_2021-01-27** executed 2021-01-29 · GC GRE Construction LLC · Owner GRE Fifth Avenue Investors LLC · Architect **GRE Construction LLC (integrated GC/architect — unusual)** · MEP Franklin Engineering · Insurance OCIP (executed 2021-06-17) · top vendor Rosen Supply Kirkland 24.8% / 155 invoices / $211,948 · 17 vendors total, $854,306 AP across 434 invoices · **7 RFIs / 82 submittals — inverse ratio of #2081's RFI-heavy/submittal-light** · retention $178,297 still held).

PROJECT_ORDER now contains 67 IDs (was 65). **Compass becomes 14 closed + 2 live (16 total — extending lead as largest GC by closed-job count)**. **GRE becomes 6 closed**. Calibration sample now n=54 (was n=52). Recalibrated via `python3 owp/build_calibration.py` and re-embedded. Headline benchmarks: hours/unit 117.4 (was 117.1) · gross_margin 38.6% (was 39.4% — slipping with the lower-margin #2081 + #2082) · loaded_wage $40.97/hr (was $40.65) · burden_multiplier 1.426 (was 1.428). Cushion codes essentially unchanged. Overrun: code 120 Roughin Labor +5.7%.

**Workspace updates this batch:**
- Compass GC_DB now 16 jobs (14 closed + 2 live), knownTag updated to flag MEP diversification (#2080 + #2081 both used Emerald City) and identify the low-margin Compass tail (#2078 23.8% / #2081 25.0%).
- GRE GC_DB now 6 jobs, knownTag updated to flag CO behavior (TRUE Mechanism B on both #2067 and #2082) and the **softening margin trend** (46.1% → 25.7% over 6 jobs in chronological order).
- Bid tool dropdown labels updated for both.
- Bulk-updated 5 prose references "52 closed jobs" → "54 closed jobs".

**Three pattern signals strengthened this batch:**

1. **Mechanism B is now N=3 across 2 GCs** (#2067 GRE Edmonds 99, #2080 Compass Redmond Sq, #2082 GRE Northgate Ph II). With #2080 it was first non-GRE Mech B; with #2082 confirms GRE consistently uses this posture (2 of 6 GRE closed jobs). The Mechanism B margin profile so far: #2067 29.8% / #2080 40.1% / #2082 25.7% — wide spread, no clean correlation with margin yet. **One thing IS clear: Mech B doesn't predict margin — too early to use it as a calibration signal.** Mech A vs Mech B is more about contract administration style than economic outcome.

2. **Emerald City Engineers MEP pattern is now N=2 — both Compass jobs.** Suggests Compass may be migrating off Franklin Engineering as their preferred MEP partner for newer projects. Worth tracking — if a 3rd Compass closed job (or live #2116 The V which is SRM but also Emerald City) confirms the pattern, "Compass-Emerald-City" becomes a real MEP archetype distinct from "Compass-Franklin" historical jobs.
...
## #2086 Compass LIZA Eastlake + #2087 Exxel Northgate Roosevelt (added 2026-04-29)

- **#2086 Compass General, LIZA Eastlake** (Seattle WA · 2517 Eastlake Ave E · Eastlake neighborhood · 260-unit mixed-use multifamily · 1,700 fixtures · $5,683,916 final / $5,369,136 base / **44 executed COs net $0 — NEW HIGHEST CO COUNT IN OWP CLOSED PORTFOLIO** (was #2078 Lake St 40 COs) · near-Mechanism B: $5.84M positive billings + $0 credits = +2.8% gross over (very tight credit posture for 44 COs) · **30.9% gross margin** · $1,753,793 net profit · 81 workers / 38,721 hrs / 34 months Sep 2021 → Jun 2024 · Subcontract **22-0500-01** executed Sept 2021 (firm fixed) · GC Compass · Owner 2517 Eastlake LLC (Bellevue WA) · MEP not confirmed in folder, likely Emerald City Engineers (Compass 2020+ pattern continues) · Insurance OCIP · top vendor **California Hydronics Corp 27.0% / 23 invoices / $454,902 — NEW vendor pattern: first time California Hydronics leads on a closed-portfolio job** (Cal Hydronics is typically a #4-5 supplier; jumping to #1 with $455k spend suggests heavy hydronic/heat-system scope) · Consolidated #2 (17.3%) and Keller #3 (15.5%) · 23 vendors total, $1,683,003 AP across 690 invoices · 75 RFIs + 18 submittals — high RFI / low submittal load · retention $284,196 still held).

- **#2087 Exxel Pacific, Northgate Roosevelt** (Seattle WA · 11201 Roosevelt Way NE · Northgate · 332-unit mixed-use multifamily · 1,850 fixtures · $6,236,066 final / $6,026,200 base / **24 executed COs net $0** — Mechanism A: $6.86M gross + $621k credits = +9.9% gross over · **47.6% gross margin — ties #2064 Jabooda for 2nd-highest single-job margin in closed portfolio** (after #2057 Plaza 49.4% and #2060 MSQ 58.2%) · **$2,966,056 net profit — HIGHEST DOLLAR NET PROFIT in any OWP closed job** (next-highest is #2077 Intracorp Shoreline at $2.34M / 41.7%) · 63 workers / 33,864 hrs / 25 months Aug 2022 → Sep 2024 · Subcontract **OWP 2087** executed 2021-12-06 · GC Exxel Pacific · Owner **Intracorp Roosevelt Apartments LP — cross-GC owner relationship** (Intracorp also owned #2077 Shoreline; here Intracorp is owner while Exxel is GC) · MEP Franklin Engineering (consistent with Exxel #2069 Theory) · Architect Ankrom Moisan (likely, not in folder) · Insurance Standard (consistent with #2069) · top vendor **Rosen Supply Kirkland 31.3% / 127 invoices / $415,914** with Consolidated 14.9% and Keller 12.8% · 21 vendors total, $1,329,576 AP across 426 invoices · 25 RFIs + 18 submittals · retention $306,303 still held).

PROJECT_ORDER now contains 71 IDs (was 69). **Compass becomes 15 closed + 2 live (17 total — extending lead as largest GC)**. **Exxel becomes 19 closed**. Calibration sample now n=58 (was n=56). Recalibrated via `python3 owp/build_calibration.py`. Headline benchmarks: hours/unit 118.7 (unchanged) · gross_margin 38.4% (unchanged — #2086 30.9% and #2087 47.6% offset each other near the median) · loaded_wage $41.56/hr (was $41.27) · burden_multiplier 1.423 (was 1.424). Cushion + overrun codes essentially unchanged.

**Workspace updates this batch:**
- Compass GC_DB now 17 jobs, knownTag updated to flag the new 44-CO record (#2086) and surface California Hydronics as a new top-vendor pattern.
- Exxel GC_DB now 19 jobs, knownTag updated with #2087 as the canonical large-mid-rise comparable (332u · 47.6% margin · highest $ net) and notes that the margin profile is the widest in portfolio (Bellevue/Main #2020 8.1% bottom → #2087 47.6% top).
- Bid dropdown labels updated for both. Exxel default option now references #2087 as the highest-$-net comparable.
- Bulk-updated 5 prose references "56 closed jobs" → "58 closed jobs".

**Three pattern signals from this batch:**

1. **Mechanism B is now N=4** (#2067 GRE, #2080 Compass, #2082 GRE, #2086 Compass — counting near-Mech B for #2086 since zero credits despite 44 COs). With #2086, the within-Compass Mech-B sub-pattern is now N=2 (#2080 + #2086) — both in the higher-margin half of closed Compass jobs. Updating my earlier "Mech B doesn't predict margin" claim: **Mech B may correlate with above-median margin within a single GC** — but cross-GC (GRE's Mech-B jobs are low-margin) it doesn't generalize. Worth a closer look once N=5+.

2. **#2086 California Hydronics top-vendor is genuinely new.** Cal Hydronics has been a #4-5 supplier across the closed portfolio with typical share 5-13% (e.g. #2086 hydronic-heavy at 27% is the outlier). #2086 jumping to #1 with $455k spend likely means the project was heat-system-heavy — large-scale hydronic equipment for the OCIP-administered Compass build. Worth verifying scope details if a 2nd Cal-Hydronics-led job appears.
